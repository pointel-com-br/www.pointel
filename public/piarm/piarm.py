...
def replace_code_signals(text):
    ...
    text = text.replace(' open braces ', ' {{Pause=1}} open braces {{Pause=1}} ')
    text = text.replace(' close braces ', ' {{Pause=1}} close braces {{Pause=1}} ')
    text = text.replace('< {{Pause=1}} equals {{Pause=1}} >', ' {{Pause=1}} left right double arrow {{Pause=1}} ')
    text = text.replace('{{Pause=1}} equals {{Pause=1}} >', ' {{Pause=1}} equals or bigger {{Pause=1}} ')
    text = text.replace('{{Pause=1}} equals {{Pause=1}} <', ' {{Pause=1}} equals or less {{Pause=1}} ')
    text = text.replace('< {{Pause=1}} equals {{Pause=1}}', ' {{Pause=1}} less or equals {{Pause=1}} ')
    text = text.replace('> {{Pause=1}} equals {{Pause=1}}', ' {{Pause=1}} bigger or equals {{Pause=1}} ')
    text = text.replace('<->', ' {{Pause=1}} left right arrow {{Pause=1}} ')
    text = text.replace('<-', ' {{Pause=1}} left arrow {{Pause=1}} ')
    text = text.replace('->', ' {{Pause=1}} right arrow {{Pause=1}} ')
    text = text.replace('-', ' {{Pause=1}} hyphen {{Pause=1}} ')
    text = text.replace('\'', ' {{Pause=1}} single quote {{Pause=1}} ')
    text = text.replace('"', ' {{Pause=1}} double quotes {{Pause=1}} ')
    text = text.replace('...', ' {{Pause=1}} three dots {{Pause=1}} ')
    text = text.replace('.', ' {{Pause=1}} dot {{Pause=1}} ')
    text = text.replace(',', ' {{Pause=1}} comma {{Pause=1}} ')
    text = text.replace(':', ' {{Pause=1}} colon {{Pause=1}} ')
    text = text.replace(';', ' {{Pause=1}} semicolon {{Pause=1}} ')
    text = text.replace('_', ' {{Pause=1}} underscore {{Pause=1}} ')
    ...
    text = text.replace('$', ' {{Pause=1}} dollar {{Pause=1}} ')
    text = text.replace('#', ' {{Pause=1}} sharp {{Pause=1}} ')
    text = text.replace('&', ' {{Pause=1}} ampersand {{Pause=1}} ')
    text = text.replace('|', ' {{Pause=1}} vertical bar {{Pause=1}} ')
    text = text.replace('~', ' {{Pause=1}} tilde {{Pause=1}} ')
    text = text.replace('^', ' {{Pause=1}} caret {{Pause=1}} ')
    ...
    text = text.replace('<', ' {{Pause=1}} less {{Pause=1}} ')
    text = text.replace('>', ' {{Pause=1}} bigger {{Pause=1}} ')
    text = text.replace('(', ' {{Pause=1}} open parenthesis {{Pause=1}} ')
    text = text.replace(')', ' {{Pause=1}} close parenthesis {{Pause=1}} ')
    text = text.replace('[', ' {{Pause=1}} open brackets {{Pause=1}} ')
    text = text.replace(']', ' {{Pause=1}} close brackets {{Pause=1}} ')
    return text
    ...
    for line in text:
        ...
        if test.startswith('```'):
            ...
            if not inside_code_block:
                test = 'Iniciando bloco de código. {{Voice=Acapela Ryan22/}}<rate absspeed=\"-3\"/> '
            else:
            ...
            if inside_code_block and line.strip():
                ...
                if last == -1:
                    ...
                    while last > -1:
                        ...
                        if next > -1:
                            make += ' {{Voice=Acapela Ryan22/}}<rate absspeed=\"-3\"/> '
