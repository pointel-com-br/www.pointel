...
Neste material, traremos uma seleção de bizus da disciplina de Governança de TI para o concurso
de Analista - Especialidade: Tecnologia.
...
com ele, pretendo abordar os tópicos mais cobrados nessa disciplina, de
maneira concisa e objetiva, por meio de uma linguagem bem clara!
...
* Gerenciamento de Serviço: Conjunto de recursos organizacionais especializados para gerar valor
...
* Serviço: Meio que permite a cocriação de valor ao facilitar a obtenção dos resultados que os
...
- Recursos de todos os tipos, pnncipalmente de RH, devem ser usados da melhor
forma;
...
QBTER/CQNSTRUIR Produzir os componentes dos serviços, desenvolver softwares, adquirir
infraest rutura,
montar arquitetura de rede etc.

ENTREGARESUPORTAR Garantir que os serviços estão sendo entregues aos usuários de acordo
com os níveis
