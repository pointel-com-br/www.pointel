...
1) Noções Iniciais: ISO 27001 e ISO 27002
...
14) Aspectos da Segurança da Informação na Gestão da Continuidade do Negócio

15) Conformidade

16) Questões Comentadas - ISO 27001 e ISO 27002 - Cebraspe

17) Questões Comentadas - ISO 27001 e ISO 27002 - FCC

18) Lista de Questões - ISO 27001 e ISO 27002 - Cebraspe
...
Essa norma é um padrão e referência Internacional para a gestão da Segurança da
Informação.
...
criando uma ação integrada da organização.

d) COMUNICAÇÃO

a. Deve-se ter rotinas muito bem definidas de comunicações internas e externas para o
SGSI, considerando "O QUE", "QUANDO", "QUEM" e o "PROCESSO".
...
Análise crítica das políticas para Segurança da
...
d) considerar a segurança da informação em qualquer tipo de projeto.
(Organização da
Segurança da Informação - Organização Interna)
...
Pessoal, os controles definidos na ISO 27002 abarcam o Sistema de
...
devem ser considerados na política a segurança física e lógica de maneira conjunta.
...
c) Está tratando de aspectos de mídias removíveis. A Seção correta é de
TRATAMENTO DE MÍDIA. ERRADO
