...
falar sobre
ações que são praticadas em base regular. Nós poderíamos dizer que é referente às
ações que
são rotineiras ou habituais. O tempo verbal Presente Simples também é usado para falar
sobre
coisas que são sempre verdade e às vezes até mesmo coisas que acontecerão
no futuro.
...
No tempo verbal Presente Simples existe apenas uma "conjugação" com exceção
dos
verbos To Be e There Be. Esses verbos são irregulares. O verbo There Be é a palavra
There +
...
Nos outros verbos sempre é usada a forma base do verbo (o infinitivo
menos o "to"), exceto
para a terceira pessoa do singular, he, she e it. A terceira pessoa do singular
requer um -s (em
alguns casos excepcionais um -es ou -ies ) para serem adicionados no final do verbo.
Vamos dar
...
Observe mais uma vez, que para todas as formas (/, you, we, they) é simplesmente
usado a
forma base do verbo, e apenas as formas he, she e it requerem que seja adicionado
um -s.
...
Câmara dos Deputados dos EUA aprova gasoduto de gás natural permitindo
projeto de lei de
reforma.
...
(ser, estar)
e There Be (haver, existir) e dos demais verbos. Pois aqueles não precisam
da ajuda de
auxiliares.
...
(existir, haver) é só
inverter a posição entre o verbo e o sujeito na frase para o verbo to be e colocar
o verbo na
...
Mas não é
aplicada para verbos que terminam em uma vogal + y. Com exceção dos
verbos acima, os
verbos que terminam em vogal + y não são considerados irregulares. Então apenas
acrescenta-
...
I spent all my childhood in Fortaleza. When I was a kid, we built a house by the
sea and I ran
every day on the beach.

Eu passei toda a minha infância em Fortaleza. Quando eu era criança, nós construímos
uma
...
Assim, é muitas vezes usado com os adjuntos adverbiais de tempo, como ontem
à noite (/ast
night), algum tempo atrás (some time ago), em 1985, hoje cedo (earlier
today), às seis horas
desta manhã (at six o'clock), a última vez (last time), a primeira vez (first time),
etc. Compare o
seguinte:
...
A primeira vez que comi escargot foi na Itália há dois anos e a última vez foi na
casa da Helena
...
observa-
se claramente que o autor está se referindo a um momento definido no
passado. Ação já
...
infinitivo e o
sujeito ou pronome pessoal é precedido do auxiliar Dl D (passado de DO,
DOES), observe a
mudança:
...
vão acontecer, estando estes situados após o ato da fala ou da escrita. É formado
pelo uso do
verbo modal ou auxiliar WILL + verbo no infinitivo sem o TO. É possível também usar
o auxiliar
Shall para expressar o futuro, seguido de verbo no infinitivo sem TO. O auxiliar
Shall é mais
usado para as primeiras pessoas (I e We). Quando usado para as demais pessoas dá
ênfase à
frase. Vejamos a seguir quais são as situações em que normalmente se
utiliza o Futuro
Simples.
...
adverbiais,
como: Tomorrow (amanhã), soon (em breve), next month (próximo
mês)/week
(próxima semana)/year(próximo ano), in a few days (em poucos dias),
in a short
...
servem para determinar se uma frase indica algo específico ou em geral. Os
Determinantes
...
O All of (todo/a, todos/as) e Each of (cada um de) podem ser seguidos por
substantivo ou
pronome no plural.
...
My mother is too kind. - Minha mãe é muito generosa/amável/gentil ou Minha
mãe é
boa/generosa demais.
...
Para se dizer: "Ela não fez nada!" Não se diz She didn't do nothing! O correto é
dizer She
...
Portanto, para evitar o duplo negativo, a frase correta para "Eles não querem nada"
deve ser
...
Ao contrário da linguagem verbal, temos a linguagem não verbal, a qual não se utiliza
do
...
trânsito e outras), pintura, cores. Ás vezes em provas de concursos, pode haver um
misto de
textos verbais e não-verbais. Isso acontece quando os textos vem acompanhados de
figuras.
Pode ser na forma de cartuns, anúncios de publicidades, campanhas, gráficos, etc. Seja
observador! Uma gravura ou foto fala mais que mil palavras. Elas são grandes aliados
na
...
delas. O número 1 mostra um prato de sopa, que está relacionado com a fome (hunger).
O
...
lágrima que cai indica algo triste (sad). Se olharmos apenas para a foto já deduzimos
que a
...
* O tempo verbal Futuro Simples (Simple Future) é formado pelo uso do verbo modal
ou
auxiliar WlLL + verbo no infinitivo sem o TO.
...
já vai
procurar as palavras que foram citadas no enunciado. Agora vá para a página da Lista
de
...
The
relevance of this tool is growing because organisations of all kinds now recognise the importance
of environmental matters and accept that their environmental performance will be scrutinised by
a wide range of interested parties. These parties will use environmental auditing to
investigate,
understand and identify actions, which help improve existing human activities, with the
aim of
reducing their adverse effects on the environment. An environmental auditor is the professional
who will, on behalf of these parties, study an organisation's environmental effects in a systematic
and documented manner and will produce an environmental audit report based on the data
provided. There are many reasons for undertaking an environmental audit, which include issues
such as environmental legislation and pressure from customers.

As a matter of definition, the term "audit" has its origins in the financial sector.
Auditing, in
general, is a methodical examination of procedures and practices aimed at verifying
whether
they comply with legal requirements, internai policies and accepted practices. The
expression
"environmental auditing" is often used as a generic term covering a variety of
management
practices used to evaluate a company's environmental performance. Strictly, it refers to checking
systems and procedures against standards or regulations, as said before, but it is often used to
cover the gathering and evaluation of any data with environmental relevance.

Considering the terminology used in the area, environmental auditing should not be
confused
with environmental impact assessment, although both are environmental management tools and
the difference between them has become blurred. The former is carried out
when a
development is already in place, and is used to check on existing practices, assessing
the
environmental effects of current activities. It is correct to say that it provides a
"snap-shot" of
looking at what is happening at that point in time in an organisation. The latter is an anticipatory
tool, that is, it takes place before an action is carried out. It is therefore an attempt to
predict the
impact on the environment of a future action, and to provide this information to those who make
the decision on whether the project should be authorised.
...
01 The product of an environmental audit is a description of an organisation's
relationship with
the environment, which should not be taken as definitive and ultimate as the data
analysed is
particular to a specific point in time.

01 O produto de uma auditoria ambiental é uma descrição da relação da organização com
o
ambiente que não deve ser tomada como definitiva e final, visto que os dados
analisados são
peculiares a um momento específico no tempo.

It is correct to say that it provides a "snap-shot" of looking at what is happening at that point in
time in an organisation.

É correto dizer que fornece um "vislumbre" do que está acontecendo naquele momento em
uma organização.

A assertiva está de acordo com o texto, ele até usa a expressão snapshot, para referir-se a um
trabalho que mostra um vislumbre ou dá uma noção do que está acontecendo em um
determinado momento no tempo, e por isso ele não é definitivo, pois a situação pode mudar.
...
02 A diferença entre a auditoria ambiental e a avaliação do impacto ambiental é clara hoje para
aqueles que trabalham com auditoria, seja no campo financeiro ou ambiental.

Considering the terminology used in the area, environmental auditing should not be
confused
with environmental impact assessment, although both are environmental management tools and
the difference between them has become blurred.

Considerando a terminologia utilizada na área, auditoria ambiental não deve ser confundida com
avaliação de impacto ambiental, embora ambas sejam ferramentas de gestão ambiental e a
diferença entre elas tenha se tornado confusa.
...
03 The work of an environmental auditor is stopping procedures which do not conform to
standards and regulations, an aim which he tries to reach by preparing reproachful reports based
on facts and data.

03 O trabalho de um auditor ambiental é interromper procedimentos que não estejam em
conformidade com as normas e regulamentos, um objetivo que ele tenta atingir pela elaboração
de relatórios de reprovação baseadas em fatos e dados.

Segundo o texto, o auditor não toma nenhuma ação para interromper
procedimentos
irregulares. O trabalho dele é produzir relatórios com base em informações coletadas na
área
analisada. Além disso, não necessariamente esses relatórios devem ser de reprovação, se estiver
tudo segundo os padrões o relatório terá um aspecto de aprovação.
...
04 In the excerpt "The latter is an anticipatory tool, that is, it takes place
before an action is
carried out", the pronoun "it" refers to "anticipatory tool".

04 No trecho "Esta última é uma ferramenta antecipatória, ou seja, ela ocorre antes de uma ação
ser executada" (I. 38 e 39), o pronome "ela" se refere a "ferramenta antecipatória" (I. 38)

Considering the terminology used in the area, environmental auditing should not be
confused
with environmental impact assessment, although both are environmental management
tools and the difference between them has become blurred.

Considerando a terminologia utilizada na área, auditoria ambiental não deve ser confundida com
avaliação de impacto ambiental, embora ambas sejam ferramentas de gestão ambiental e a
diferença entre elas tenha se tornado confusa.

Numa questão desse tipo, se precisa analisar o contexto. O pronome it retoma o que foi citado
anteriormente e refere-se a avaliação do impacto ambiental (environmental impact assessment).

GABARITO: ERRADA

05 The expressions "scrutinised" (in the second sentence on the first paragraph), "undertaking"
(in the fifth sentence on the first paragraph) and "comply with" (in the second
sentence on the
second paragraph) can be respectively replaced by probed, setting about and conform to
without this harming the text's coherence and meaning.

05 As expressões "examinados" (1.7), "empreendendo" (1.15) e "cumprir" (1.21) podem ser
respectivamente substituídas por investigados, estabelecendo e em conformidade com,
sem prejudicar a coerência e sentido do texto.
...
Ao substituir no texto cada palavra por seu respectivo par, não há nenhuma alteração
no
significado ou coerência da frase, pois os termos são sinônimos.
...
effects of certain activities on the environment against set criteria or standards. The relevance of
this tool is growing because organisations of all kinds now recognise the
importance of
environmental matters and accept that their environmental performance will be scrutinised by a
wide range of interested parties. These parties will use environmental auditing to
investigate,
understand and identify actions, which help improve existing human activities, with the
aim of
reducing their adverse effects on the environment. An environmental auditor is the professional
...
A auditoria ambiental é essencialmente uma ferramenta de gestão ambiental para medir os
efeitos de certas atividades no meio ambiente em relação a critérios ou padrões estabelecidos.
A relevância desta ferramenta está crescendo porque organizações de todos os tipos agora
reconhecem a importância das questões ambientais e aceitam que seu desempenho ambiental
sejam examinados por uma ampla gama de partes interessadas. Essas partes utilizarão a
auditoria ambiental para investigar, compreender e identificar ações que ajudem a melhorar as
atividades humanas existentes, com o objetivo de reduzir seus efeitos adversos ao meio
ambiente. Um auditor ambiental é o profissional que irá, em nome dessas partes,
estudar os
efeitos ambientais de uma organização de forma sistemática e documentada e produzir um
relatório de auditoria ambiental com base nos dados fornecidos. Existem muitos motivos
para
realizar uma auditoria ambiental, que incluem questões como legislação ambiental e pressão dos
clientes.
...
A
auditoria, em geral, é um exame metódico dos procedimentos e práticas com o objetivo
de
verificar o cumprimento dos requisitos legais, políticas internas e práticas aceitas. A
expressão
"auditoria ambiental" é frequentemente usada como um termo genérico que abrange uma
variedade de práticas de gestão usadas para avaliar o desempenho ambiental de uma empresa.
Estritamente, refere-se à verificação de sistemas e procedimentos em relação a padrões
ou
regulamentos, como dito antes, mas é freqüentemente usada para proteger a coleta e avaliação
de quaisquer dados com relevância ambiental.
...
Considerando a terminologia utilizada na área, auditoria ambiental não deve ser confundida com
avaliação de impacto ambiental, embora ambas sejam ferramentas de gestão ambiental e a
diferença entre elas tenha se tornado confusa. A primeira é realizada quando
um
empreendimento já está implantado e serve para verificar as práticas existentes,
avaliando os
efeitos ambientais das atividades atuais. É correto dizer que fornece um "vislumbre" do que está
acontecendo naquele momento em uma organização. Esta última é uma ferramenta
antecipatória, ou seja, ocorre antes de uma ação ser executada. É, portanto, uma
tentativa de
...
customers they needed to visit that day, and a separate five- or six-page document
listing
...
company invested in a custom mobile app called eMobile, Samsung Galaxy tablets with
10.1-
inch screens and cellular service from Sprint. Rather than receiving stacks of paper each morning,
drivers simply download the day's route onto their tablets via the eMobile app. As
they move
along, the mounted tablets tell them exactly where to stop. When drivers arrive at
customers'
homes, they push one of three buttons on the touchscreen: "done," "not out" or
"skip." Daily
Disposal's entire fleet now has mounted tablets. All residential drivers are using the solution, and
drivers who pick up from commercial and construction sites will begin using it soon.
And the
...
a empresa Daily Disposal já implementou o uso dessas tecnologias para clientes
particulares,
...
O vice-presidente da empresa, Todd Ottonello, diz que a iniciativa está ajudando nos
esforços
...
businesses and construction sites in San Diego. In the past, drivers with residential
routes
received two printouts each morning: a 30-page document listing more than 1,000
customers
they needed to visit that day, and a separate five- or six-page document listing customers
with
delinquent accounts.
...
customer's containers. With more than 90 drivers in the field, Daily Disposal needed a
more
...
10.1-inch screens and cellular service from Sprint. Rather than receiving stacks of
paper each
morning, drivers simply download the day's route onto their tablets via the eMobile app. As they
move along, the mounted tablets tell them exactly where to stop. When drivers arrive
at
customers' homes, they push one of three buttons on the touchscreen: "done," "not out"
or
...
commercial and
construction sites will begin using it soon. And the company is looking for other
ways to
automate operations. "What we're doing may seem simple, but it's huge for us," says
Todd
Ottonello, vice president of the company. "This also helps with our efforts to go
green. The
...
power position tended to mimic the smile of a person with high status. On the other
hand,
people who feel powerful return smiles of lower status individuais but refrain from
smiling back
...
All fifty-five subjects in the study mimicked frowns of people they were told were
high-
status individuais, like doctors, more than those from low-status jobs like fast-food workers. The
...
to mimic
the facial expressions and body language of others, and subordinates are more prone to
this
type of behavior of submission.

"Subordinates will smile more, they'll nod more, they'll tilt their heads more, which
is a
...
more conscious of their body language in order to give off the proper signals in
specific
...
Carol Kinsey Goman, que não é filiada ao estudo, disse que os seres humanos estão ligados
desde o nascimento a imitar as expressões faciais e linguagem corporal dos outros, e
os
...
mean, to use it to make a point you want to make, is when body language is
helpful", Goman
said.
...
Researchers at the University of Califórnia, San Diego (UCSD), found that people in a low-power
position tended to mimic the smile of a person with high status. On the other hand, people who
feel powerful return smiles of lower status individuais but refrain from smiling back to others in a
...
All fifty-five subjects in the study mimicked frowns of people they were told were
high-status
individuais, like doctors, more than those from low-status jobs like fast-food workers. The author
...
expressions and body language of others, and subordinates are more prone to this type
of
...
linguagem corporal dos outros, e os subordinados são mais propensos a este
tipo de
...
responses come naturally. The implication of studies like these is that employees can be
more
conscious of their body language in order to give off the proper signals in specific
situations.
"Learning what these cues mean, to use it to make a point you want to make, is
when body
...
estes é que os funcionários podem ser mais conscientes de sua linguagem corporal, a
fim de
emitir os sinais adequados em situações específicas. "A linguagem corporal é útil
quando se
...
7 of exercising one or more assessment objects under specified conditions to compare
actual
...
13 discussions with individuais or groups within an organization to facilitate
understanding,
...
an
organization to facilitate understanding, achieve clarification, or identify the
location of
evidence.

Entrevistar é o processo de realizar discussões com indivíduos ou grupos dentro de uma
organização para facilitar a compreensão, obter esclarecimentos, ou identificar o local
de
provas.
...
object) meets specific security objectives. Three types of assessment methods can be
used to
accomplish this — testing, examination, and interviewing.

Uma avaliação da segurança da informação é o processo de determinar
como
efetivamente uma entidade que está sendo avaliada (por exemplo, host, sistema,
rede,
procedimento, pessoa - conhecida como o objeto de avaliação) atende aos
objetivos
...
Os resultados da avaliação são utilizados para apoiar a determinação da eficácia de controle
...
Se substituirmos um pelo outro, isso vai alterar a compreensão textual, pois eles não
têm o
mesmo significado nesse contexto. Mas, observe na definição acima que em um contexto
diferente os dois podem ser sinônimos: quando o used to for precedido pelo verbo to
be e
significar "está acostumado". E o accostumed também for precedido pelo to be.
...
do not require a high school education, experience in the data processing and entry
field is
...
clerical and
administrative skills such as word processing and database management, in addition to
the
traditional English, math, and science courses that are usually offered. There are also
at-home
...
Observe no segmento do texto que o exigido é um conhecimento básico de Inglês e não
um
conhecimento profundo como diz a assertiva. A palavra sound tem vários significados e é usada
como verbo, adjetivo e substantivo. O seu significado mais conhecido é som, barulho
(sound).
...
Para aquelas vagas que não exigem o ensino médio, geralmente é exigido como
uma
...
Observe que não há nenhuma alteração na interpretação ao substituirmos no texto a
palavra
...
School = qualquer escola incluindo todos os níveis e o ensino especializante ou
superior. Ex:
escola de secretariado, escola de karatê, etc; faculdade, universidade.
...
habilidades básicas de escrita e administrativas, como processamento de texto e gestão
de
...
Há também tutoriais on-line para se estudar em casa, em livros e gravações, que
ensinam
...
proficiência substancial em matemática e ciência também pode ser útil para trabalhos em
que
são processados materiais técnicos ou relatórios estatísticos.
...
processamento de dados. Escolas de ensino médio, escolas profissionais e
faculdades
...
Technicians need to possess good communication skills, be able to function in a
fast-paced
environment and adapt to new technologies quickly. Their job may involve being able to
work
...
Os técnicos precisam possuir boas habilidades de comunicação, ser capazes de trabalhar em um
ambiente com um ritmo acelerado e se adaptar às novas tecnologias rapidamente. O
trabalho
...
In order for young people to do better in school, it helps if they actually are in
school.
Schools basically have two options when it comes to fighting chronic truancy. There's
the
positive approach, in which students are rewarded with iPads, sneakers, gift cards, and
other
incentives merely for showing up at school. Then there's the flip side, in which
students and
parents are penalized for unexcused absences. In the past, parents have been sentenced to jail
time for failing to get their children to school. Prosecutors have also suggested jail
time as a
...
justificadas. No passado, os pais foram condenados a pena de prisão por não mandarem
os
...
parent-teacher
conferences. Now there's a school system in the news because its superintendent plans
on
...
the job done. A plan to fine students $ 75 per skipped school day is now being
considered by
New Britain council members.

Em New Britan, Connecticut, um novo superintendente de escolas chamado Kelt Cooper quer
acabar com as taxas de evasão escolar altas entre alunos de escolas públicas, e ele
está
propondo sanções monetárias para conseguir isso. Um plano para multar estudantes de 75 por
dia de ausência na escola agora está sendo considerado pelos membros do conselho de
New
Britain.
...
O conceito de multar as crianças para faltar a escola pode vir como um choque, mas
não é
nova.

A alternativa não está correta devido a sua primeira parte que especifica o fato de
multar
...
250 dólares para cada contagem de evasão escolar; no início de 2012 a lei foi
alterada e as
...
acabar com as taxas de evasão escolar altas entre alunos de escolas públicas, e ele
está
propondo sanções monetárias para conseguir isso. Um plano para multar alunos em 75 dólares
por dia de ausência na escola agora está sendo considerado pelos membros do conselho
de
New Britain.
...
Em Ohio, os tutores responsáveis por um aluno culpado de evasão escolar habitual podem ser
multados em até 500 dólares e / ou ser obrigados a realizar 70 horas de serviço comunitário.
...
dólares para cada contagem de evasão escolar; no início de 2012 a lei foi alterada e as multas
...
paper on which data was represented by a series of holes, a technology now obsolete. Electronic
data storage, which is used in modem computers, dates from World War II, when a form
of
delay-line memory was developed to remove the clutter from radar signals, the first
practical
application of which was the mercury delay line. The first random-access digital storage
device
was the Williams tube, based on a standard cathode ray tube, but the information
stored in it
was volatile in that it had to be continuously refreshed, and thus was lost once
power was
removed. The earliest form of non- volatile computer storage was the magnetic drum, invented
in 1932 and used in the Ferranti Mark 1, the world's first commercially available general-purpose
electronic computer.
...
standard
cathode ray tube, but the information stored in it was volatile in that it had to
be continuously
refreshed, and thus was lost once power was removed.
...
voláteis, pois precisavam ser continuamente atualizadas e por isso eram perdidas quando
a
...
compreensão textual. No texto, a expressão "was removed" está no tempo verbal Voz Passiva.
O formato é verbo to be+particípio. Por isso o verbo que o substitui é taken out
(particípio) e
não take out.
...
Early electronic computers such as Colossus made use of punched tape, a long strip of paper on
which data was represented by a series of holes, a technology now obsolete. Electronic
data
storage, which is used in modem computers, dates from World War II, when a form of delay-line
memory was developed to remove the clutter from radar signals, the first practical application of
which was the mercury delay line.

Os primeiros computadores eletrônicos, como o Colossus, usavam fita perfurada, uma longa tira
de papel na qual os dados eram representados por uma série de furos, uma tecnologia
agora
obsoleta. O armazenamento eletrônico de dados, usado em computadores modernos, data da
Segunda Guerra Mundial, quando uma forma de memória de linha de atraso foi desenvolvida
para remover a desordem dos sinais de radar, cuja primeira aplicação prática foi a linha de atraso
de mercúrio.
...
cathode ray tube, but the information stored in it was volatile in that it had to
be continuously
refreshed, and thus was lost once power was removed. The earliest form of non-volatile
computer storage was the magnetic drum, invented in 1932 and used in the Ferranti Mark 1, the
...
voláteis, pois precisavam ser continuamente atualizadas e por isso eram perdidas quando
a
energia era desligada. A forma mais antiga de armazenamento de computador não volátil foi o
tambor magnético, inventado em 1932 e usado no Ferranti Mark 1, o primeiro computador
eletrônico de uso geral comercialmente disponível.
...
The worn wooden floorboards squeak under Rafael Molinazs heavy steps as he paces the
...
actor
and stuntman. "My aspiration was to see a film set firsthand. Today I own one of
the most
...
Almería
province. Since the late 1950s, these rugged mountains, arid plains, and dry canyons
have
provided the backdrops for more than 170 movie Westerns, including The Good, The Bad
and The Ugly (1966) and Once Upon a Time in The West (1968).

Molina belongs to a small community of local cowboy actors and stuntmen in Tabernas
who have played a role in movies and TV shows since the first productions in the 1950s. They can
perform anything from fistfights to horse drags. Knowledge and skills often pass from
father to
son, keeping tricks of the trade in the family. Steeped in the golden era of
Westerns, these
actors embody the values of their movie heroes: pride, bravado, freedom, and a trusting
relationship with horses.

"I've always liked horses and the [U.S.] West," says 29- year-old Ricardo Cruz Fernández, a
stuntman and cowboy who appeared in recent productions including Game of
Thrones.
Fernández started his career as a cowboy after completing a stuntman course a decade ago.

Between productions, he performs daily shows at Fort Bravo for thousands of tourists who
visit the set each year. In one show, Fernández portrays a bank robber who absconds with some
gold. Visitors encounter him in the saloon, fist and (fake) gun fighting with actors
playing his
double-crossing accomplices. The town also offers cancan dance shows and set tours by horse-
drawn wagon.
...
We have sea, desert, and snowy mountains all within a short distance," says local
producer
Plácido Martínez. "We can serve as Texas, New México, Arizona, Califórnia, and endless other
natural settings."
...
Texas. É uma das três cidades fictícias do Velho Oeste na pequena aldeia de Tabernas
e no
deserto circundante da província de Almería.

De acordo com segmento do texto acima, realmente há 3 cidades cenográficas localizadas na
província de Almería, na Espanha.

GABARITO: CERTA

40 In the fifth paragraph, the word "stuntman" means a man who performs a dangerous action,
which needs to be done by someone skilled, especially instead of an actor in a film or television
programme.

40 No quinto parágrafo, a palavra "dublê" significa um homem que executa uma ação perigosa
que precisa ser feita por alguém qualificado, especialmente em vez de um ator em um filme ou
programa de televisão.

"I've always liked horses and the [U.S.] West," says 29-year-old Ricardo Cruz
Fernández, a
stuntman and cowboy who appeared in recent productions including Game of Thrones.
Fernández started his career as a cowboy after completing a stuntman course a decade ago.

"Sempre gostei de cavalos e do oeste [dos EUA]", diz Ricardo Cruz Fernández, 29 anos,
um
dublê e cowboy que apareceu em produções recentes, incluindo Game of Thrones.
Fernández começou sua carreira como cowboy depois de concluir um curso de dublê há uma
década.
...
Pelo contrário, o texto diz que esses atores incorporam os valores de seus heróis do
cinema:
orgulho, bravura, liberdade e uma relação de confiança com os cavalos.

GABARITO: ERRADA

42 In the fragment 'The good guy only has to keep things in order', the word 'has'
could be
correctly replaced with must, without changing the meaning of the text.

42 No fragmento 'O mocinho só tem que manter as coisas em ordem', a palavra 'tem' poderia
ser substituída corretamente por deve, sem alterar o sentido do texto.

Às vezes, "must" e "have to" podem ser usados para falar sobre responsabilidades. No entanto,
"must" é geralmente usado para fortes obrigações pessoais e "have to" é
usado para
responsabilidades no trabalho e na vida cotidiana. Portanto, nessa frase eles
não são
intercambiáveis.
...
Cuidado! Sempre preste atenção ao contexto, pois ele é importantíssimo para a correta
interpretação de texto. Quando o texto diz: "Podemos ser usados como se fosse o
Texas, o
Novo México, o Arizona, a Califórnia e inúmeros outros cenários naturais", ele não
está se
referindo aos atores, mas sim às paisagens onde são feitas as filmagens.

GABARITO: ERRADA

44 In the sentence "In one show, Fernández portrays a bank robber who absconds with some
gold", the fragment "absconds with" could be correctly replaced with keeps, without
changing
the meaning of the text.
...
Observe que os verbos não são sinônimos. Portanto, não podem substituir um ao outro
sem
alterar o sentido do texto.

GABARITO: ERRADA

45 The fragment "Fernández started his career as a cowboy after completing a stuntman course
a decade ago" can be correctly rewritten as A decade ago, Fernández started his career as a
cowboy and then he completed a stuntman course, without changing the meaning of
the text.

45 O fragmento "Fernández iniciou sua carreira como vaqueiro depois de concluir um curso de
dublê há uma década" pode ser reescrito corretamente como Há uma década, Fernández
iniciou sua carreira como cowboy e depois completou um curso de dublê, sem
alterar o significado do texto.

Primeiro, ele fez o curso de dublê, e só depois então iniciou sua carreira. Portanto, a frase não
pode ser reescrita assim como na alternativa, pois isso alteraria a compreensão do texto.

GABARITO: ERRADA

46 lt can be inferred from the text that many different productions were made in
Almería
because its landscapes are very convenient and diversified.
...
(O
Exterminador do Futuro: Destino Sombrio) e programas de TV (Doutor Who). "Nossas
paisagens são muito convenientes. Temos mar, deserto e montanhas nevadas a uma curta
distância", diz o produtor local Plácido Martínez. "Podemos ser usados como se fosse o Texas, o
Novo México, o Arizona, a Califórnia e inúmeros outros cenários naturais."
...
"When I was a kid, I could only dream about all this," says the 68-year-old former actor and
stuntman. "My aspiration was to see a film set firsthand. Today I own one of the most famous
ones in the history of Western movies."

"Quando eu era criança, eu só podia sonhar com tudo isso", diz o ex-ator e dublê de 68 anos.
"Minha aspiração era ver um set de filmagem em primeira mão. Hoje possuo um dos mais
famosos da história dos filmes de faroeste."

O segmento do texto acima deixa bem claro que a alternativa concorda com o texto.

GABARITO: CERTA

48.According to the text, in Spain there are villages that were very important cities
during the
...
Outside, the sound of galloping horses breaks the silence of the surrounding desert. All around
him, the Old West town's empty shops and abandoned houses look as if they have just
been
ransacked by cowboy bandits.

As tábuas de madeira gastas rangem sob os passos pesados de Rafael Molina enquanto ele anda
pelo salão. Lá fora, o som de cavalos a galope quebra o silêncio do deserto circundante. Ao seu
redor, as lojas vazias e as casas abandonadas da cidade do Velho Oeste parecem ter
sido
saqueadas por bandidos cowboys.

"When I was a kid, I could only dream about all this," says the 68-year-old former
actor and
stuntman. "My aspiration was to see a film set firsthand. Today I own one of the
most famous
ones in the history of Western movies."
...
Texas. É uma das três cidades fictícias do Velho Oeste na pequena aldeia de Tabernas
e no
deserto circundante da província de Almería. Desde o final da década de 1950, essas montanhas
...
to son,
keeping tricks of the trade in the family. Steeped in the golden era of Westerns,
these actors
embody the values of their movie heroes: pride, bravado, freedom, and a trusting
relationship
with horses.

Molina pertence a uma pequena comunidade de atores e dublês cowboys locais em Tabernas
que têm atuado em filmes e programas de TV desde as primeiras produções na década de 1950.
Eles podem realizar qualquer coisa, desde brigas até ser arrastados por cavalos. Conhecimentos
e habilidades muitas vezes passam de pai para filho, mantendo os truques do ofício na família.
Imersos na era de ouro dos faroestes, esses atores incorporam os valores de seus
heróis do
cinema: orgulho, bravura, liberdade e uma relação de confiança com os cavalos.
...
Between productions, he performs daily shows at Fort Bravo for thousands of tourists who visit
the set each year. In one show, Fernández portrays a bank robber who absconds with some gold.
Visitors encounter him in the saloon, fist and (fake) gun fighting with actors playing his
double-
crossing accomplices. The town also offers cancan dance shows and set tours by horse-drawn
wagon.

Entre as produções, ele realiza shows diários no Fort Bravo para milhares de turistas que visitam
o set todos os anos. Em um show, Fernández retrata um ladrão de banco que foge com algum
ouro. Os visitantes o encontram no salão, socos e tiroteios (falsos) com atores interpretando seus
cúmplices traiçoeiros. A cidade também oferece shows de dança cancan e passeios de carroças
puxadas por cavalos.
...
Learning a second language as an adult is difficult. But the process may be eased if you
exercise while learning. A new study reports that working out during a language class

4 amplifies people's ability to memorize, retain and understand new vocabulary. The
findings
provide more evidence that to activate our minds, we should move our bodies.

7 Many scientists suspect that exercise alters the biology of the brain in ways that
make it
more malleable and receptive to new information, a process that scientists refer to as
...
make it more
malleable and receptive to new information, a process that scientists refer to as plasticity.

Muitos cientistas suspeitam que o exercício altera a biologia do cérebro de uma forma
que o
torna mais maleável e receptivo a novas informações, um processo que os cientistas chamam de
plasticidade.

O segmento do texto acima deixa bem claro que o exercício físico é importante para manter a
...
the brain
becomes incapable of acquiring a second language.

51.Os cientistas usam o termo "plasticidade" (1.10) para descrever o processo pelo qual
o
cérebro se torna incapaz de adquirir uma segunda língua.
...
Pelo contrário, a plasticidade do cérebro torna-o mais receptivo a novas informações, o
que
inclui o aprendizado de uma nova língua.
...
A new study reports that working out during a language class amplifies/increases
people's
ability to memorize, retain and understand new vocabulary.

Um novo estudo relata que fazer exercícios físicos durante uma aula
de idioma
amplia/aumenta a capacidade das pessoas de memorizar, reter e compreender o
novo
vocabulário.

Amplifies - ampliar, amplificar, aumentar = increase - ampliar, aumentar, incrementar

As palavras são sinônimas. Portanto, podem ser substituídas uma pela outra sem alterar
a
...
However, these studies do not suggest that schools or teachers should buy bicycles for students
to exercise during class.

No entanto, esses estudos não sugerem que escolas ou professores devam comprar bicicletas
para os alunos fazerem exercícios durante as aulas.

However= no entanto, entretanto, todavia, mas

Nesse tipo de questão é importante que você analise o contexto. O however é uma conjunção
adversativa que faz um contraste entre o que foi dito antes e depois dela. O texto
fala que
embora o exercício ajude no aprendizado, ele não deve ser feito concomitantemente com
as
aulas.
...
ser facilitado se
você se exercitar enquanto aprende. Um novo estudo relata que fazer exercícios físicos
durante
uma aula de idioma amplia a capacidade das pessoas de memorizar, reter e
compreender o
novo vocabulário. As descobertas fornecem mais evidências de que, para ativar nossas
mentes,
devemos mover nossos corpos.

Many scientists suspect that exercise alters the biology of the brain in ways that
make it more
malleable and receptive to new information, a process that scientists refer to as plasticity.

Muitos cientistas suspeitam que o exercício altera a biologia do cérebro de
uma forma que o
torna mais maleável e receptivo a novas informações, um processo que os cientistas
chamam de
plasticidade.

However, these studies do not suggest that schools or teachers should buy bicycles for
students
to exercise during class. A simpler message may be that instruction should
be alternated with
physical activity. Sitting for hours and hours without moving is not the best way to learn.

Internet: <www.nytimes.com> (adapted).

No entanto, esses estudos não sugerem que escolas ou professores devam
comprar bicicletas
para os alunos fazerem exercícios durante as aulas. Uma mensagem mais simples pode ser
que a
instrução deve ser alternada com a atividade física. Ficar sentado por horas
e horas sem se
mover não é a melhor maneira de aprender.
...
watercourses
have provided drinking water, transportation, energy, and a means to dispose of waste,

4 and thus it is not a great surprise that nearly all major cities are built on
river corridors, lakes, or
oceans. The small streams within settlements have served as important sources of water

7 and a source of aquatic plants and animais. Urban watercourses, however,
quickly become
highly polluted through human activity. They have been used for sewage

10 disposal and the disposal of harmful industrial waste, and many urban streams and
rivers have
...
16 systems and treated them as potential assets to neighbourhoods rather than as
problems to
be managed or paved over. Although follow-up studies are incomplete and site
specific, once
stream

19 daylighting is completed, stream neighbours tend to agree that daylighting
creates an asset.
A study of Strawberry Creek and Baxter Creek in Califórnia, two early examples of daylighting,

22 showed increased land values and general good opinion of the creeks.
Related research
supports such a conclusion in that proximity to green areas and waterways
are perceived as
beneficiai.
...
O texto não diz isso. Segundo o texto, a iluminação natural é um dos fatores que
têm causado
valores elevados da terra.
...
O autor afirma que os pequenos riachos dentro dos assentamentos têm
servido como
importantes fontes de água e que os cursos de água urbanos (em geral) rapidamente se
tornam
altamente poluídos pela atividade humana. Portanto, não se pode dizer que os pequenos
cursos
...
The idea of reclaiming urban streams emerged in force during the 1970s and
is well
summarized in the landmark paper by Nelson Nunnally, "Stream Renovation: an
Alternative to
Channelization". Nunnally saw streams as open hydraulic systems and treated them as
potential
assets to neighbourhoods rather than as problems to be managed or paved over.
...
os riachos como sistemas abertos hidráulicos e os tratou
como possíveis recursos para os bairros, e não como problemas a serem
gerenciados ou
pavimentados.
...
Humans have a long-standing relationship with water. Throughout history,
watercourses have
provided drinking water, transportation, energy, and a means to dispose of waste, and
thus it is
not a great surprise that nearly all major cities are built on river corridors, lakes, or oceans.

Os humanos têm uma relação de longa data com a água. Ao longo da história, os
cursos d'água
forneceram água potável, transporte, energia e um meio para descartar o lixo, e, por
isso, não é
...
source of
aquatic plants and animais. Urban watercourses, however, quickly become
highly polluted
through human activity. They have been used for sewage disposal and the
disposal of harmful
industrial waste, and many urban streams and rivers have been covered over and
diverted into
sewers.

Os pequenos riachos dentro dos assentamentos têm servido como importantes fontes de
água e
uma fonte de plantas e animais aquáticos. Mas, os cursos de água urbanos
rapidamente se
tornam altamente poluídos pela atividade humana. Eles têm sido usados para
descarte de
resíduos de esgoto e evacuação de resíduos industriais prejudiciais, e muitos
córregos e rios
urbanos foram cobertos e desviados para esgotos.

The idea of reclaiming urban streams emerged in force during the 1970s and is well
summarized
in the landmark paper by Nelson Nunnally, "Stream Renovation:
an Alternative to
Channelization". Nunnally saw streams as open hydraulic systems and treated them as
potential
assets to neighbourhoods rather than as problems to be managed or paved over.
...
A ideia de recuperar riachos urbanos surgiu em vigor durante os anos 1970 e está bem
resumido
no artigo de referência de Nelson Nunnally, "Renovação de Córrego:
uma Alternativa à
Canalização". Nunnally viu os riachos como sistemas abertos hidráulicos e os
tratou como
possíveis recursos para os bairros, e não como problemas a serem
gerenciados ou
pavimentados.

Although follow-up studies are incomplete and site specific, once stream
daylighting is
completed, stream neighbours tend to agree that daylighting creates an asset.
A study of
Strawberry Creek and Baxter Creek in Califórnia, two early examples of
daylighting, showed
increased land values and general good opinion of the creeks. Related research supports
such a
conclusion in that proximity to green areas and waterways are perceived as beneficiai.

Environments: A journal of interdisciplinary studies.

Embora os estudos de acompanhamento sejam incompletos e específicos do local, uma vez
que
a iluminação natural do riacho é concluída, os vizinhos do riacho tendem a
concordar que a
iluminação natural cria uma vantagem. Um estudo de Strawberry Creek e Baxter
Creek na
Califórnia, dois primeiros exemplos de iluminação natural, mostrou valores
elevados da terra e
boa opinião geral sobre os riachos. Pesquisas relacionadas apoiam essa
conclusão, pois a
...
nível
surrounding imediações,
cercanias, arredores, em volta
threat ameaça,
intimidação
truancy cábula, falta às
aulas
waste
lixo, desperdício; desperdiçar
...
measuring
the effects of certain activities on the environment against set
criteria or standards. The
relevance of this tool is growing because organisations of all kinds now recognise the
importance
of environmental matters and accept that their environmental performance will
be scrutinised by
a wide range of interested parties. These parties will use environmental
auditing to investigate,
understand and identify actions, which help improve existing human activities,
with the aim of
reducing their adverse effects on the environment. An environmental auditor is
the professional
who will, on behalf of these parties, study an organisation's environmental effects in
a systematic
and documented manner and will produce an environmental audit report based on
the data
provided. There are many reasons for undertaking an environmental audit, which
include issues
such as environmental legislation and pressure from customers.

As a matter of definition, the term "audit" has its origins in the
financial sector. Auditing, in
general, is a methodical examination of procedures and practices aimed at
verifying whether
they comply with legal requirements, internai policies and accepted practices.
The expression
"environmental auditing" is often used as a generic term covering a variety
of management
practices used to evaluate a company's environmental performance. Strictly, it refers to
checking
systems and procedures against standards or regulations, as said before, but it is
often used to
cover the gathering and evaluation of any data with environmental relevance.

Considering the terminology used in the area, environmental auditing should not
be confused
with environmental impact assessment, although both are environmental management
tools and
the difference between them has become blurred. The former is carried
out when a
development is already in place, and is used to check on existing
practices, assessing the
environmental effects of current activities. It is correct to say that it
provides a "snap-shot" of
looking at what is happening at that point in time in an organisation. The latter is
an anticipatory
tool, that is, it takes place before an action is carried out. It is therefore an
...
01 The product of an environmental audit is a description of an
organisation's relationship with
the environment, which should not be taken as definitive and ultimate as
the data analysed is
particular to a specific point in time.

02 The difference between environmental auditing and environmental impact
assessment is
nowadays clear for those who work with auditing, be it in the financial
field or in the
environmental one.

03 The work of an environmental auditor is stopping procedures which do not
conform to
standards and regulations, an aim which he tries to reach by preparing reproachful
reports based
on facts and data.

Based on the text, judge the following items.

04 In the excerpt "The latter is an anticipatory tool, that is, it takes
place before an action is
carried out", the pronoun "it" refers to "anticipatory tool".

05 The expressions "scrutinised" (in the second sentence on the first
paragraph), "undertaking"
(in the fifth sentence on the first paragraph) and "comply with" (in the second
sentence on the
second paragraph) can be respectively replaced by probed, setting about and
conform to
without this harming the text's coherence and meaning.

Texto 2: Analista de Gestão de Resíduos Sólidos - Informática - SLU-DF - CESPE - 2019

The solid-waste disposal company Daily Disposal services tens of
thousands of
residences, businesses and construction sites in San Diego. In the past,
drivers with residential
routes received two printouts each morning: a 30-page document listing more
than 1,000
customers they needed to visit that day, and a separate five- or six-page
document listing
customers with delinquent accounts. As drivers made stops, they had to compare the two
lists to
determine whether to pick up each customer's containers. With more than 90 drivers in the field,
...
tablets with 10.1-
inch screens and cellular service from Sprint. Rather than receiving stacks of paper
each morning,
drivers simply download the day's route onto their tablets via the eMobile
app. As they move
along, the mounted tablets tell them exactly where to stop. When drivers
arrive at customers'
homes, they push one of three buttons on the touchscreen: "done," "not out"
or "skip." Daily
Disposal's entire fleet now has mounted tablets. All residential drivers are using the
solution, and
drivers who pick up from commercial and construction sites will begin using
it soon. And the
company is looking for other ways to automate operations. "What we're doing may seem
simple,
but it's huge for us," says Todd Ottonello, vice president of the company. "This also
helps with
our efforts to go green. The solution completely changes an industry."

Taylor Mallory Holland. Tablets bring waste management technology into
the digital
...
Researchers at the University of Califórnia, San Diego (UCSD), found that people in a
low-
...
"Mimicry has been shown to help build relationships, and both power and status seem to
affect how we unconsciously employ this strategy," said Evan Carr,
the lead researcher.
Participants' facial responses were detected as minuscule, unconscious movements
of facial
muscles fractions of a second after being shown videos of people of varying social status.

All fifty-five subjects in the study mimicked frowns of people they were
told were high-
status individuais, like doctors, more than those from low-status jobs like
fast-food workers. The
author of The Nonverbal Advantage: Secrets and Science of Body Language at
Work, Carol
Kinsey Goman, who is not affiliated with the study, said humans are wired from birth
to mimic
the facial expressions and body language of others, and subordinates are more
prone to this
type of behavior of submission.

"Subordinates will smile more, they'll nod more, they'll tilt their heads
more, which is a
kind of universal sign of listening", she said. In line with the UCSD study's
findings, Goman said
these responses come naturally. The implication of studies like these is that
employees can be
more conscious of their body language in order to give off the proper
signals in specific
situations. "Learning what these cues mean, to use it to make a point you want to
make, is when
body language is helpful", Goman said.
...
4 assessment object) meets specific security objectives. Three types of assessment
methods can
be used to accomplish this — testing, examination, and interviewing. Testing is the process

7 of exercising one or more assessment objects under specified conditions to
compare actual
and expected behaviors. Examination is the process of checking, inspecting, reviewing,

10 observing, studying, or analyzing one or more assessment objects to facilitate
understanding,
achieve clarification, or obtain evidence. Interviewing is the process of
conducting discussions
with individuais or groups within an organization to facilitate understanding,
...
In the United States, most data processing technician jobs require at most a high
school
diploma. For those who start work

3 immediately after high school, training is usually provided on the job. For those
positions that
...
A good grasp of basic English skills is important for technician positions. Solid
proficiency
in math and science may also be useful for jobs in which technical material or
statistical reports
are processed.
...
vocational schools, and community colleges have classes that teach basic
clerical and
administrative skills such as word processing and database management, in
addition to the
traditional English, math, and science courses that are usually offered. There
are also at-home
tutorials online and in books and tapes that teach similar skills.

Technicians need to possess good communication skills, be able to function in
a fast-
paced environment and adapt to new technologies quickly. Their job may involve
being able to
work well with team members as well as independently.
...
Schools basically have two options when it comes to fighting chronic truancy.
There's the
positive approach, in which students are rewarded with iPads, sneakers, gift
cards, and other
incentives merely for showing up at school. Then there's the flip side, in
which students and
parents are penalized for unexcused absences. In the past, parents have been sentenced
to jail
time for failing to get their children to school. Prosecutors have also
suggested jail time as a
penalty for missing parent-teacher conferences. Now there's a school system in
the news
because its superintendent plans on fining families $ 75 for each day a student skips school.
...
penalties to
get the job done. A plan to fine students $ 75 per skipped school day is now being
considered
by New Britain council members.

The concept of fining kids for skipping school may come as a shock, but it's not
new. In
Ohio, the guardians responsible for a student guilty of habitual truancy can be fined
up to $ 500
and/or be required to perform up to 70 hours of community service. Until
recently, students in
Los Angeles could be hit with a $ 250 penalty for each count of truancy; in early
2012 the law was
amended and the expensive fines were removed, though a $ 20 penalty may still be
handed out
for the third offense.
...
Electronic
data storage, which is used in modem computers, dates from World War II,
when a form of
delay-line memory was developed to remove the clutter from radar signals, the
first practical
application of which was the mercury delay line. The first random-access
digital storage device
was the Williams tube, based on a standard cathode ray tube, but the
information stored in it
was volatile in that it had to be continuously refreshed, and thus was
lost once power was
removed. The earliest form of non- volatile computer storage was the magnetic
drum, invented
in 1932 and used in the Ferranti Mark 1, the world's first commercially available
general-purpose
electronic computer.
...
The worn wooden floorboards squeak under Rafael Molina's heavy steps as he paces the
saloon. Outside, the sound of galloping horses breaks the silence of the surrounding
desert. All
around him, the Old West town's empty shops and abandoned houses look as if they
have just
been ransacked by cowboy bandits.

"When I was a kid, I could only dream about all this," says the 68-year-old former
actor
and stuntman. "My aspiration was to see a film set firsthand. Today I own
one of the most
famous ones in the history of Western movies."

But this busy movie site is located in Spain — not Montana or Texas. It's one of
three faux
Old Western towns in the small village of Tabernas and the surrounding desert
of the Almería
province. Since the late 1950s, these rugged mountains, arid plains, and dry
canyons have
provided the backdrops for more than 170 movie Westerns, including The Good,
The Bad
and The Ugly (1966) and Once Upon a Time in The West (1968).

Molina belongs to a small community of local cowboy actors and stuntmen in
Tabernas
who have played a role in movies and TV shows since the first productions in the
1950s. They can
perform anything from fistfights to horse drags. Knowledge and skills often
pass from father to
son, keeping tricks of the trade in the family. Steeped in the golden era
of Westerns, these
actors embody the values of their movie heroes: pride, bravado, freedom, and
a trusting
relationship with horses.

"I've always liked horses and the [U.S.] West," says 29- year-old Ricardo Cruz
Fernández, a
stuntman and cowboy who appeared in recent productions including Game
of Thrones.
Fernández started his career as a cowboy after completing a stuntman course a decade ago.

Between productions, he performs daily shows at Fort Bravo for thousands of tourists
who
visit the set each year. In one show, Fernández portrays a bank robber who absconds
with some
gold. Visitors encounter him in the saloon, fist and (fake) gun fighting
with actors playing his
double-crossing accomplices. The town also offers cancan dance shows and set tours by
horse-
drawn wagon.

"I prefer to play the bad guy, because it gives me a wider range of
possibilities," says
Fernández. "The good guy only has to keep things in order."

Almería has hosted more than 500 productions, including blockbuster
films (Patton,
Terminator: Dark Fate) and TV shows (Doctor Who). "Our landscapes are very
convenient.
We have sea, desert, and snowy mountains all within a short distance," says
local producer
Plácido Martínez. "We can serve as Texas, New México, Arizona, Califórnia,
and endless other
natural settings."
...
40 In the fifth paragraph, the word "stuntman" means a man who performs a dangerous
action,
which needs to be done by someone skilled, especially instead of an actor in a film
or television
programme.
...
4^1 In the sentence "In one show, Fernández portrays a bank robber who absconds with
some
gold", the fragment "absconds with" could be correctly replaced with keeps,
without changing
the meaning of the text.

45 The fragment "Fernández started his career as a cowboy after completing a
stuntman course
a decade ago" can be correctly rewritten as A decade ago, Fernández started his
career as a
cowboy and then he completed a stuntman course, without changing the
meaning of
the text.

46 lt can be inferred from the text that many different productions were
made in Almería
because its landscapes are very convenient and diversified.
...
Learning a second language as an adult is difficult. But the process may be eased if
you
exercise while learning. A new study reports that working out during a language class
...
7 Many scientists suspect that exercise alters the biology of the brain in
ways that make it
more malleable and receptive to new information, a process that scientists refer to as

10 plasticity.

However, these studies do not suggest that schools or teachers should buy
bicycles for
students to exercise during class. A simpler message may be that
...
51 Scientists use the term "plasticity" (R.10) to describe the process
...
have provided drinking water, transportation, energy, and a means to dispose of waste,
and thus
it is not a great surprise that nearly all major cities are built on river
corridors, lakes, or oceans.
The small streams within settlements have served as important sources of water and a
source of
aquatic plants and animais. Urban watercourses, however, quickly become
highly polluted
...
and
many urban streams and rivers have been covered over and diverted into sewers. The
idea of
12reclaiming urban streams emerged in force during the 1970s and is well
summarized in the

14 landmark paper by Nelson Nunnally, "Stream Renovation: an Alternative to
Channelization".
Nunnally saw streams as open hydraulic systems and treated them as potential
assets to
neighbourhoods rather than as problems to be managed or paved over.
...
* Além das questões de Interpretação de textos foram abordados assuntos
como
...
seguir no mesmo passo, manter-se adequadamente informado ou atualizado = adapt
quickly = adaptar-se rapidamente
