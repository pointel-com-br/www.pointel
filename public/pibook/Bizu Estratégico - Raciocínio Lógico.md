...
para
auxiliá-lo(a) na disciplina de Raciocínio Lógico. Fiz uma análise bem cautelosa dos
pontos mais
...
entre si, resultando numa única declaração.
...
P v q p e q forem diferentes p e q forem iguais
...
S Para conectivos iguais, adota-se a convenção de associar os parênteses da direita para
a esquerda.
...
O argumento dedutivo é válido quando a conclusão é nec essa ri a in e nte verdade i ra quando se
...
"todo... não...11
poderemos trocá-la por "nenhum". Não há mudança de sentido ao
reescrever as
...
precisamos
associar. Para conseguir responder esse tipo de questão com tranquilidade, é necessária
uma
estratégia.
...
montar
uma tabela com quatro parâmetros que queremos associar: amigo, altura, esporte que
pratica
