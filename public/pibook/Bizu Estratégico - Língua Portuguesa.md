...
âmbito da disciplina de Português, nos últimos anos:
...
Com relação à "Ortografia e Acentuação", apesar de não ser muito explorada
diretamente
pela banca, seu domínio é fundamental para um bom desempenho em "Reescrita de Frases",
tópico com incidência mediana em provas. Assim, "Ortografia e Acentuação" será
estudada
como um subtópico de "Reescrita de Frases".
...
Meu nome é Leonardo Mathias, tenho 33 anos e sou natural do Rio
...
nos principais certames militares de nível médio existentes no Brasil (Colégio Naval e
EPCAr).
Após quase 13 anos de vida na caserna, decidi buscar novos horizontes de vida e
voltei a
estudar para concursos públicos, tendo tido a felicidade de ser aprovado em alguns
concursos,
inclusive da Área Fiscal, mas optei por tornar-me Auditor de Controle Externo do
TCE-SP.

Como pode perceber, há pouco tempo, eu estava justamente aí onde você, concurseiro,
está.
Logo, utilizarei as experiências e conhecimentos adquiridos ao longo da minha trajetória
para
auxiliá-lo(a) na disciplina de Português. Fiz uma análise bem cautelosa dos
pontos mais
...
sua atenção para um fato muito importante. Por fins didáticos, esse assunto costuma
aparecer
...
comando da questão (enunciado), identificando se a questão deseja que você extraia
alguma
...
o O leitor deve buscar no texto aquela informação, sabendo que a resposta
estará
...
pressuposto, ou seja, uma pista, vestígios que o texto traz, ou uma
informação
...
Antes de adentrarmos, efetivamente, nos bizus sobre coesão e coerência, faremos uma
rápida
abordagem sobre Semântica.

4) Semântica
o A semântica trata das relações de sentido entre as palavras. Elas podem
ser
...
5) Coerência
o A coerência observa as relações de sentido e lógica que um texto oferece. O texto
...
o A coerência se constrói pela manutenção da expectativa que o uso de
certas
palavras traz ao leitor. Nesse sentido, a contradição gera incoerência.

6) Coesão
o A coesão está relacionada com a "ligação" entre palavras e partes do
texto,
recuperando e adiantando informação;

Fui ao supermercado comprar legumes. Não havia nada lá. Isso nunca tinha
ocorrido antes.

o A coesão não garante a lógica do texto, mas nos ajuda a enxergarmos a coerência
dele;

o Quando o mecanismo de coesão retoma um termo ou informação que veio antes
dele, há coesão anafórica;

o Quando "anuncia" um termo ou informação que aparecerá depois, diz-se que
há
coesão catafórica.
...
> Isolam termos explicativos acessórios. Nessa função, podem ser substituídos
por
...
Não dou ouvidos ao político (com artigo definido: político
específico,
...
Classe invariável que pode modificar verbo, adjetivo e outro
advérbio.
Normalmente indicam a circunstância dos verbos. Podem ocorrer também as
locuções adverbiais, expressões iniciadas por preposição que exercem função
de advérbio. O corrupto morreu de fome (causa). O corrupto morreu fuzilado
(modo).
...
Fatores de atração antes do verbo atraem pronome proclítico: palavras
...
24)Sujeito Simples
o Concorda com o núcleo.

o Cuidado com a distância entre sujeito e verbo,

o Comece pelo verbo e trace uma seta até o sujeito.

25)Coletivos ou partitivos especificados
o Essa é a regra para expressões como: a maioria de, a minoria de uma porção de, um
bando de, um grande número de + determinante (termo preposicionado que
modifica o substantivo coletivo ou partitivo).

o Concordam com o núcleo do sujeito (parte) ou com o adjunto
adnominal
(determinante) ligado a ele. É facultativo!

A metade dos servidores públicos entrou/entraram em greve.

26) Fração
o O verbo concorda com o numerador.
...
27) Porcentagens
o O verbo concorda com o próprio numeral ou com o determinante.
...
determinante fizer parte do nome.
...
29)Sujeito Indeterminado
o Verbo no singular - PIS (VTI/VI + SE)

Vive-se bem aqui.

30) Oração sem sujeito
o Não tem sujeito, não há flexão: verbo no singular.
...
Trocou por sinônimo (ocorrer/acontecer/existir), o verbo sinônimo concorda
com o sujeito.

* Há vários livros ali. Haverá novos conflitos. Existem livros. Ocorrerão
novos conflitos. Poderá haver conflitos.
...
34) Discurso direto
o É narrado em primeira pessoa, retratando as exatas palavras dos personagens.
Caracteriza-se pelo uso de verbos declarativos, como dizer, falar, afirmar, ponderar,
retrucar, redarguir, replicar, perguntar, responder, pensar, refletir, indagar e outros
que exerçam essa função. A pontuação se caracteriza pela presença de dois pontos,
travessões ou aspas para isolar as falas, que são claramente alternadas, bem como
de sinais gráficos, como interjeições, interrogações e exclamações, para indicar
o
...
35) Discurso indireto
o É narrado em terceira pessoa e o narrador incorpora a fala dos personagens a sua
própria fala, também utilizando os verbos de elocução como dizer, falar,
afirmar,
ponderar, retrucar, redarguir, replicar, perguntar, responder, pensar,
refletir,
indagar. Trata-se de uma paráfrase, uma reescritura das falas, agindo o narrador
como intérprete e informante do que foi dito. Geralmente traz uma
oração
subordinada substantiva, com a conjunção que.

"A certo ponto da conversação, Glória me disse que desejava muito conhecer
Carlota e perguntou por que não a levei comigo."

36) Discurso indireto livre
o É um discurso híbrido, haja vista que concilia características dos dois anteriores.
Há
...
após alguns minutos, respondeu que não era nada. Perdera o costume de
fazer discursos é o que era."
...
o Oculto/Elíptico/Desinencial: Pode ser determinado pelo contexto ou vem implícito
na terminação da palavra: Estudamos hoje (nós -> referente).
...
Estar/fazer/haver impessoal com sentido de tempo ou estado: Faz tempo que
não vou à praia. Faz frio em Corumbá.

41) Predicativo do Sujeito
o Indica estado/qualidade/característica do sujeito.

o Fulana é bonita (VL). Ele tornou-se chefe (VL). João saiu contente (VI).

42)Objeto Direto
o Complemento verbal sem preposição. Complementa VTD.
...
o Preposicionado: Amava a Deus (preposição tem mero valor enfático). Deixei a quem
me magoava (pronome demonstrativo pediu a preposição). Convidou apenas a mim.
(Pronome oblíquo tônico pediu a preposição). Quer enganar a todos, mas não
engana a ninguém (pronomes indefinidos pediram a preposição).
...
43)Objeto Indireto
o Complemento verbal com preposição. Complementa VTI.
...
44)Complemento Nominal
o Termo preposicionado ligado ao nome (substantivo, adjetivo, advérbio) que
possui
...
46)Adjunto Adnominal x Complemento Nominal
o Diferenças

O complemento nominal se liga a substantivos abstratos, adjetivos e
advérbios. O adjunto adnominal só se liga a substantivos.
...
se aquele nome for transformado numa ação: complemento nominal.

47)Adjunto Adverbial
...
o Pode vir em forma de oração, então teremos as orações subordinadas
adverbiais
finais, temporais, proporcionais, causais, consecutivas, conformativas, comparativas,
concessivas.

Ele morreu porque estava doente (oração adverbial de causa).

48) Aposto
o Reitera ou reforça o termo a que se refere. Pode ser explicativo ou restritivo.
...
Se restritivo, NÃO deve ser separado por vírgulas. O jogador da seleção
brasileira Neymar Júnior celebrou contrato milionário.

49)Classificações da palavra SE

o Pronome apassivador (PA): Vendem-se casas.

o Partícula de indeterminação do sujeito (PIS): Vive-se bem aqui. Trata-se de uma
exceção.
...
o Pronome reflexivo: Minha tia se barbeia. Nesse caso, "se" tem função sintática de
objeto direto, pois o sujeito e o objeto são a mesma pessoa.

o Pronome recíproco: Irmão e irmã se abraçaram. Nesse caso, equivale a abraçaram
um ao outro e o "SE" terá função sintática de objeto direto.

o Parte integrante de verbo pronominal (PIV): Candidatou-se à presidência e se
arrependeu. Esse "se" não tem função sintática, é parte integrante do verbo!
...
o Preposição acidental: Tenho que passar o quanto antes (equivale a "tenho de
passar").
...
S As palavras geralmente têm um sentido mais direto, mais clássico, mais primário, que
imediatamente se manifesta quando ouvimos ou lemos aquela sequência de sons ou
letras. Esseé o sentido denotativo, o sentido direto, primário, principal do dicionário.

Ex: o leão é o animal mais visitado do zoológico.

o Veja que "leão" está sendo usado em sua acepção mais clássica, como animal.

V Por outro lado, num determinado contexto, a palavra pode assumir
um novo
sentido, figurado,metafórico, especial, não óbvio.

Ex: Esse lutador batendo é um leão; apanhando, é um gatinho.

o Agora a palavra "leão" deixou de designar o animal para indicar figuradamente
uma pessoa que tem a característica da ferocidade. Já o gatinho tem a
característica de ser pequeno, inofensivo. Esse é um sentido figurado,
metafórico, conotativo.

52)Sinônimos e Antônimos

V Sinônimos: São palavras que se aproximam semanticamente por uma relação de
...
S Homônimos homógrafos: palavras que têm a mesma grafia, mas trazem sentidos
diferentes.

S Homônimos homófonos: palavras que têm a mesma pronúncia, mesmo som, mas trazem
sentidosdiferentes.

Homônimos perfeitos: São palavras que têm som e grafia idênticos, diferenciando-se
somentepelo sentido. Quase sempre, são palavras de classes diferentes.
...
dessas palavrastambém é muito importante para interpretação de texto e questões
de vocabulário.
...
ascensão (subida) assunção (elevação a
um cargo)

bebedor (aquele que bebe) bebedouro (local onde se
bebe)

cavaleiro (que cavalga) cavalheiro (homem
gentil)
...
docente (relativo a professores) discente (relativo a
alunos)

emigrar (deixar um país) 'migrar (entrar num
país)

eminência (elevado) 'minência (qualidade
do que está iminente)

eminente (elevado) 'minente (prestes a
ocorrer)

esbaforido (ofegante, apressado) espavorido (apavorado)

estada (permanência em um lugar) estadia (permanência temporária
em um lugar)
...
sortir (abastecer, misturar) surtir (produzir
efeito)
