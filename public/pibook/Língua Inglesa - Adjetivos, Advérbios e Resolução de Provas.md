...
5) Resumo Aula 02 Teoria

6) Questões Comentadas e Textos Traduzidos A2 TI

7) Tabelas de Vocabulários e Sinônimos A2 TI
...
h) That fiIm was so (depressing / depressed)'.
...
e) Lisa is her boss. (intellicient)

f) Brazil is Germany. (big)

Gabarito:

a) Helen é mais jovem do que Bob.

b) Laranjas são mais doces do que limões. - Oranges are sweeter than limes.

c) Buenos Aires é mais fria do que o Rio. - Buenos Aires is colder than Rio.

d) Inglês é mais fácil do que português. - English is easier than Portuguese.

e) Lisa é mais inteligente do que seu chefe. - Lisa is more intelligent than her boss.
...
Na primeira frase acima a palavra "friendly" é adjetivo pois descreve um substantivo:
person
...
C diz que o AudtFile permitiu à sua empresa ampliar sua carteira de clientes. Essa é a correta.
...
(C) lf you keep walking you will find the right path.
...
(B) o sistema não oferece nenhum formulário que possa substituir o Premium
Finance
Agreement.

(C) o Premium Finance Agreement só pode ser elaborado por um advogado da Secretaria de
Estado.
...
Analista Legislativo (Analista de Sistemas) - CMSJC - VUNESP

As questões de números 21 a 25 utilizam frases extraídas do livro "Introduction
Algorithms",
...
(C) limitações = limitations

(D) facilidade = facility
(E)vantagens = advantages
...
...na maioria das vezes é o tempo computacional que queremos medir.

mensure = mensurar, medir
...
(B) encerrou uma era de estudos sobre algoritmos.

(C) focou na análise ampla dos algoritmos modernos de computadores.
...
O verbo que significa consolidar é consolidate ou reinforce. Opção errada.
...
Usher in = inaugurar, começar, anteceder

A opção traduz corretamente o significado do verbo do texto. Esta é a opção correta.
...
Leia o texto I e responda as questões 31 a 33.
...
Analista de Sistemas Júnior - FAPESP - VUNESP

Leia o texto para responder às questões de números 27 a 31.
...
(B) are going to avoid modem applications.
...
(C) the effective use of new tools relies on proper training.

(D) it will be hard to integrate different IT practices.
...
Take off = atingir o sucesso ou popularidade (avançar, progredir);
remover, deduzir,
...
* Nessa aula o que mais foi cobrado foi Interpretação de Texto e Tempos Verbais.

Esse tópico de Interpretação também é o mais cobrado na prova do concurso.

* O termo silver bullet significa "arma infalível, solução garantida para um problema difícil".

* Dê atenção às palavras e expressões abaixo:
...
* wanting = decepcionante, insatisfatório, deficiente, que falta, desprovido de,
insuficiente, ausente, desconcertante

* Strength = ponto forte, força

* Take off = atingir o sucesso ou popularidade (avançar, progredir); remover, deduzir,
descontinuar, liberar;
...
Texto 1: Auditor Fiscal de Tributos I - Tecnologia da Informação (TI) - Prefeitura de
São Luís - MA
...
The sentence in which the word in bold has the same function as the word "snooping"
(line 17)
is
...
(C) o Premium Finance Agreement só pode ser elaborado por um advogado da
Secretaria de
Estado.
...
Texto 7: Analista de Sistemas Júnior - FAPESP - VUNESP
...
Texto 3 20-E; 21-A; 22-E; 23-E; 24-A; 25-D;

Texto 4 23-C; 24-B; 25-C; 26-A; 27-E;

Texto 5 21-B; 22-C; 23-C; 24-D; 25-E;
