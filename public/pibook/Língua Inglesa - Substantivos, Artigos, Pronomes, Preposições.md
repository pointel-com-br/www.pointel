...
você entende como as frases são formadas, vai ficar mais fácil para você entender a
ideia
...
verbos (verbs), adjetivos (adjectives), advérbios (adverbs), preposições (prepositions),
artigos
(articles) e conjunções (conjunctions). A estrutura mais básica é a frase simples (the
simple
...
(ou ambos) ou um complemento do sujeito. A Sigla SVO indica que a frase é formada
por
...
Ele trabalha no centro da cidade em uma escola; a esposa dele trabalha em um
escritório
próximo.
...
Entretanto, quando você for ler, você vai rapidamente perceber que você precisa
inverter a
...
diferentes funções como sujeito, objeto direto, objeto indireto, complemento do sujeito
ou
...
Assinale se o substantivo é simples (S) ou composto (C) e traduza cada um deles
a) ( ) Bottles
b) ( ) Driving license
c) ( ) Government
d) ( ) Income Tax
...
Substantivo T radução
accountant contador(a)

actor / actress ator/atriz
boy / girl menino, rapaz /menina,
moça
...
The author's conclusions: As conclusões do autor
...
c) Os filhos de Bob e Mary são lindos bebês (os bebês são dos dois, Bob é o pai e Mary é a
mãe)
...
Os artigos (articles) em Inglês são três: o Definido (The = o, a, os, as) e os
Indefinidos
...
reunião o interlocutor se refere. O artigo "a" transmite uma ideia abrangente, geral.
E a
...
isso são antecedidas pelo artigo "a". Ex: a European - se pronuncia
'yer-o-pi-an'
(Europeu/Europeia), e assim também são pronunciados: a eulogy (discurso fúnebre, tributo), a
urologista (urologista), a union (união, sindicato), a United front ( uma frente
unida), a used
book (um livro usado), a U.S. flag (uma bandeira dos Estados Unidos), a
user
...
casos. Ela é
uma vogal apenas nos grupos de duas letras <aw>, <ew> e <ow>. Em qualquer outro
lugar

<w> é uma consoante. Exemplos: a window (uma janela), a week (uma semana), a way (um
caminho, um modo), a writer (um(a) escritor(a)), a woman (uma mulher). Da mesma forma,
o "a"
é usado quando o "o" faz o mesmo som que "w" em "won". Ex: a one-time
charge (uma
...
ouvintes não
conhecem ou não foi mencionado antes. Ele é usado antes de substantivos no
singular,
contáveis que começam com vogal. Exs: an Indian (um(a) índio/a), an uprising (uma
revolta),
...
Foi usado an em an invitation (e não the) pois a pessoa que pergunta
não sabe a que
convite o interlocutor se refere. O artigo an transmite uma ideia abrangente, geral. E
a palavra
...
a) UMA empresa company
b) UMA banana banana
c) UMA estratégia strategy
d) UMA recessão recession
e) UMA faculdade colleoe
f) UM disco voador UFO
...
a) Last night my father boughtmagazine because he wanted to
readinteresting article
aboutnew investments in Brazil.

b) We'll buybig company inEurope. There'sbig
warehouse, butparking
lot is small.
...
h) My cousin intends to be a manager. He intends to manage department
in a big
...
Objeto
(Object Pronouns) equivalentes ao caso oblíquo. São palavras pequenas que você
pode usar
para substituir uma pessoa ou coisa, quando você já falou sobre eles, ou
seja, usamos os
pronomes pessoais quando não é necessário repetir nomes ou frases nominais aos quais
eles
...
Globalization is both a cause and a result of the modem
information revolution. It
...
no
plural substituem mais de um elemento: pessoa ou coisa. Observe no quadro acima que o
You
pode ser usado para substituir tanto uma pessoa como mais de uma pois ele
serve para
ambos: singular e plural. O Ité o pronome pessoal que nós usamos ao invés de she/her
ou
he/him quando nos referimos a coisas antes que a pessoas, no singular. Compare os
seguintes
...
João é um bom professor. Ele ensina na escola de ensino médio. Eu o conheço desde
que eu
tinha doze anos.

This ring is over a hundred years old. It used to belong to my mother. I gave it
to my daughter
when she was twelve years old.

Este anel tem mais de cem anos. Ele pertencia a minha mãe. Eu o dei à minha filha
quando ela
tinha doze anos.

O pronome pessoal it é usado também quando não tem nenhuma pergunta ou
nome o
...
Cuidado! Não confunda lt's com Its, o primeiro é a contração do pronome pessoal
sujeito It +
is (verbo to be na terceira pessoa do singular) e o segundo, Its é o pronome
possessivo da
...
Os pronomes pessoais they e them também são usados como pronomes neutros
quanto ao
gênero, quando não sabemos se o sujeito é masculino ou feminino, e podem
referir-se a
ambos: coisas e pessoas.

Where are my T-shirts? - They're on the top shelf. - I can't find them.

Onde estão minhas camisetas? ~ Elas estão na prateleira de cirna.- Eu não consigo
encontrá-
las.
...
b) The buyer intends to buy components as soon as possible because the assembly line
has to
work 24 hours a day.(they; he) intends to buy(it;
them) from a local
supplier.

c) Last week John Cowhand, our accountant, decided to check some
data.(he; she)

wanted to check(it; them) on the computer screen.

d) The manager would like to change some procedures. He would like
to change(it;
...
Pronomes
Reflexivos (Reflexive Pronouns) são usados para indicar que a ação reflexiva recai
sobre o
próprio sujeito. Nesse caso, o pronome vem logo após o verbo e concorda com o sujeito.

Estes pronomes se caracterizam pelas terminações self (no singular) e se/ves (no
plural). Para
...
pronomes
adjetivos possessivos (possessive adjectives pronouns) e outra para
os pronomes
substantivos possessivos (possessive pronouns). Os pronomes substantivos possessivos
e os
adjetivos possessivos mostram a quem o elemento pertence. Observe na tabela
abaixo na
primeira coluna estão os adjetivos possessivos (que acompanham os substantivos); na
segunda,
...
d) (our / ours) course is the best on the market. On the
other hand,(their /
theirs) is the worst.
...
h) The cities and (their / theirs) inhabitants face several
problems with the heavy
storm.

i) (my / mine) neighbor is a nice person, but (her /
hers) is very noisy and
impolite.
...
apontar,
indicar e mostrar alguma coisa, lugar, pessoa ou objeto. Esses pronomes podem
atuar como
adjetivos, antes do substantivo, ou como pronomes substantivos.
Observe mais
...
principal. A
palavra, frase ou ideia modificada é chamada de antecedente. Os principais pronomes
relativos
são that, who, whom, whose e which. O who é usado apenas para se referir a pessoas.
O
whose é usado para expressar possessão. O which é usado apenas para coisas,
situações,
objetos e animais e o that pode ser é usado para ambos: pessoas e coisas. O whom é
mais
...
whose identity is known to us and whose job would be
jeopardized by its
...
f) O email que eu enviei a ela era sobre os novos investimentos na
planta/fábrica na
Argentina.
...
quando os
substituem, ou adjetivos, quando qualificam os substantivos. Veja nos quadros
abaixo os
...
Swipe a card at this ATM, and you get something more
valuable than cash.
(www.takepart.com)
...
any
algum(s)(a),nenhum(s)(a), qualquer
none nenhum(a)

some
algum(s)(a),algo, um (s)(a), um pouco de
...
Since its creation in 1930, the Bank for International Settlements (BIS) acts as a
cooperation
...
Despite/Spite of increases in data transparency, there is still very little transparency
on
...
ahead of à frente de, adiante de,
na dianteira
during durante
...
I (eu)- myself A mim mesmo, -me
lt (ele, ela /neutro)- itself A si mesmo (a), -se
...
1 PrPornoonmomesesInIdnedfeinfindiodsosImImpepsesosaoiasis Tradução
...
something alguma coisa, algo
li PrPornoonmomesesInIdnedfeinfindiodsosdedelulguagraerses Tradução
anywhere qualquer lugar
(interrogativa); nenhum
lugar (negativa)

everywhere em todo lugar
somewhere em algum lugar
about
em torno de, cerca de, sobre, por volta
de
according to de acordo com, na opinião
de
ahead of à frente de, adiante de,
na dianteira
during durante
...
as
questões, pois assim será mais proveitoso. Vá então agora para a Lista de
Questões no final da aula e comece por lá. Sucesso!
...
stories about
Martians, some of whom invade Earth, like in the 1938 radio drama, The War of the Worlds.
According to an enduring urban legend, many listeners believed the story to be real
news
...
Martian
inhabitants. Movies like Total Recall (1990 and 2012) take us to a terraformed Mars
and a
struggling colony running out of air. A Martian colony and Earth have a prickly relationship in
The Expanse television series and novels.
...
Uma colônia marciana e a Terra têm um relacionamento espinhoso na série de televisão de
romances chamada "A Expansão".
...
"pacifico". No
entanto, o primeiro gabarito da banca foi CERTA. O CESPE resolveu optar pela anulação da
questão no seu gabarito definitivo.
...
que muitos acreditaram que era real e entraram em pânico.
...
inteligente residia em Marte, por causa dos canais. Isso não é o mesmo que, "começar
as
...
atmosphere. Mars is also a dynamic planet with seasons, polar ice caps, canyons,
extinct
volcanoes, and evidence that it was even more active in the past. No other planet has captured
our collective imagination quite like Mars.

Marte é o quarto planeta a partir do Sol - um mundo empoeirado, frio e desértico
com uma
atmosfera muito fina. Marte também é um planeta dinâmico com estações, calotas polares,
cânions, vulcões extintos e evidências de que foi ainda mais ativo no passado. Nenhum outro
planeta conseguiu capturar tanto a nossa imaginação coletiva como Marte.
...
No final de 1800, quando as pessoas observaram pela primeira vez as características
semelhantes a canais na superfície de Marte, muitos especularam que uma espécie alienígena
inteligente residia lá. Isso levou a inúmeras histórias sobre marcianos, alguns dos quais invadem
a Terra, como no drama de rádio de 1938, A Guerra dos Mundos. De acordo com uma lenda
urbana duradoura, muitos ouvintes acreditaram que a história era uma cobertura noticiosa real
de uma invasão, causando pânico generalizado.
...
Inúmeras histórias desde então ocorreram em Marte ou exploraram as possibilidades de seus
habitantes marcianos. Filmes como "O Vingador do Futuro / Desafio Total" (1990 e 2012) nos
levam a um Marte terraformado e uma colônia em dificuldades que está ficando sem ar. Uma
colônia marciana e a Terra têm um relacionamento espinhoso na série de televisão de
romances chamada "A Expansão".
...
extreme events. According to the Fourth National Climate Assessment, published in 2018
by
the U.S. Global Change Research Program, "more frequent and intense extreme weather and
climate-related events, as well as changes in average climate conditions, are expected
to
...
community to study whether specific extreme events can be partially attributed to human
activities. With the help of climate models, scientists have conducted an impressive
array of
studies, looking for possible links between human activities and extreme events such as heat
waves, rainfall and flooding events, droughts, storms, and wildfires. Increasingly, they're able to
draw robust connections.
...
04 Certain extreme weather and climate-related events are happening more often
and
becoming more intense.

04 Certos eventos climáticos extremos e relacionados ao clima estão acontecendo com mais
frequência e se tornando mais intensos.
...
O segmento acima logo no início do texto deixa bem claro que realmente eventos climáticos
intensos ou perigosos estão acontencendo com mais frequência.

GABARITO: CERTA

ATENTO!

05 The author points out human contributions as a noteworthy reason for the growing number
of extreme events.

05 O autor aponta as contribuições humanas como uma razão significativa para o
crescente
número de eventos extremos.

With the help of climate models, scientists have conducted an impressive array of
studies,
looking for possible links between human activities and extreme events such as heat
waves,
rainfall and flooding events, droughts, storms, and wildfires. Increasingly, they're able to draw
robust connections.

Com a ajuda de modelos climáticos, os cientistas realizaram uma impressionante variedade de
estudos, procurando possíveis ligações entre as atividades humanas e eventos extremos, como
ondas de calor, chuvas e eventos de inundação, secas, tempestades e incêndios
florestais.
...
O segmento acima deixa bem claro que o autor expressa que a contribuição humana nesses
eventos extremos é digna de nota, forte, realista.
...
O texto não apresenta uma predição. O foco do texto é divulgar as pesquisas sobre o que tem
desencadeado ou causado esses extremos eventos.
...
There's growing evidence that people and the planet are increasingly impacted by extreme
events. According to the Fourth National Climate Assessment, published in 2018 by the
U.S.
...
Há evidências crescentes de que as pessoas e o planeta são cada vez mais impactados por
eventos extremos. De acordo com a Quarta Avaliação Climática Nacional, publicada em 2018
pelo Programa de Pesquisa de Mudanças Globais dos EUA, "espera-se que eventos climáticos
extremos mais frequentes e intensos e relacionados ao clima, bem como mudanças nas
condições climáticas médias, continuem a danificar infraestruturas, ecossistemas, e
sistemas
sociais que fornecem benefícios essenciais para as comunidades".
...
À medida que os impactos de eventos extremos continuam aumentando, cresce o interesse da
comunidade científica em estudar se eventos extremos específicos podem ser parcialmente
atribuídos às atividades humanas. Com a ajuda de modelos climáticos, os cientistas realizaram
...
The European Environment Agency (EEA) has published a new indicator that tracks
findings of pesticides in Europe's rivers, lakes and groundwaters. The data, collected from EEA
member countries across Europe, shows the share of water bodies where excessive leveis of
pesticides have been recorded from 2013 to 2019.

The new EEA indicator shows that leveis of pesticides exceeding thresholds were
measured in a quarter of all reported monitoring sites in European surface waters in
2019.
From 2013 to 2019, this share varied between 13% and 30%. The share for groundwater with
exceedances was considerably lower, at between 3% and 7%.

In the EU, pesticides are regulated on the basis of high protection goals for human
health and the environment, with being authorised only after a comprehensive scientific
risk
assessment. Nevertheless, pesticide contamination of surface waters and groundwater can still
...
07 From 2013 to 2019, the percentage of sites in European surface waters whose leveis
of
pesticides are above the limits more than doubled.
...
inferior, situando-se entre 3% e 7%. Portanto, não houve duplicação como diz a assertiva.
...
08 Contamination by pesticides in European waters is less likely to occur than in other places in
the world due to strict control policies.

08 A contaminação por pesticidas em águas europeias é menos provável do que em outros
lugares do mundo devido a políticas de controle rígidas.

O texto diz que: "Na UE, os pesticidas são regulamentados com base em objetivos de
alta
proteção para a saúde humana e o meio ambiente, sendo autorizados somente após uma
avaliação científica abrangente dos riscos. No entanto, a contaminação por pesticidas das
águas superficiais e subterrâneas ainda pode ocorrer e afetar a fauna e a flora aquáticas." Em
nenhum momento é dito que essa contaminação é menos provável que em outros lugares.

GABARITO: ERRADA

The European Environment Agency (EEA) has published a new indicator that tracks findings of
pesticides in Europe's rivers, lakes and groundwaters. The data, collected from EEA
member
countries across Europe, shows the share of water bodies where excessive leveis of pesticides
have been recorded from 2013 to 2019.

A Agência Europeia do Ambiente (AEA) publicou um novo indicador que acompanha as
descobertas de pesticidas nos rios, lagos e águas subterrâneas da Europa. Os dados, coletados
de países membros da AEA em toda a Europa, mostram a proporção de corpos d'água onde
foram registrados níveis excessivos de pesticidas de 2013 a 2019.

The new EEA indicator shows that leveis of pesticides exceeding thresholds were measured in
a quarter of all reported monitoring sites in European surface waters in 2019. From
2013 to
...
europeias em 2019. De 2013 a 2019, essa parcela variou entre 13% e 30%. A percentagem das
águas subterrâneas com excedências foi consideravelmente inferior, situando-se entre 3% e
7%.

In the EU, pesticides are regulated on the basis of high protection goals for human health and
the environment, with being authorised only after a comprehensive scientific risk assessment.
Nevertheless, pesticide contamination of surface waters and groundwater can still occur
and
could affect aquatic fauna and flora.

Internet: <www.eea.europa.eu> (adapted)

Na UE, os pesticidas são regulamentados com base em objetivos de alta proteção para a
saúde humana e o meio ambiente, sendo autorizados somente após uma avaliação científica
abrangente dos riscos. No entanto, a contaminação por pesticidas das águas superficiais
e
subterrâneas ainda pode ocorrer e afetar a fauna e a flora aquáticas.
...
places on Earth, has burned in wildfires worsened by climate change. What happens to a rich
...
Australia,
the Western United States and the Amazon, its celebrity sibling to the north. But
while the
Pantanal is not a global household name, tourists in the know flock there because it is home to
exceptionally high concentrations of breathtaking wildlife: Jaguars, tapirs, endangered
giant
otters and bright blue hyacinth macaws. Like a vast tub, the wetland swells with water during
the rainy season and empties out during the dry months. Fittingly, this rhythm has a name that
evokes a beating heart: the flood pulse.

The wetland, which is larger than Greece and stretches over parts of Brazil, Paraguay
and
Bolívia, also offers unseen gifts to a vast swath of South América by regulating the water cycle
upon which life depends. Its countless swamps, lagoons and tributaries purify water and help
...
drought
worsened by climate change turned the wetlands into a tinderbox and the fires raged
out of
control.
...
droughts. -
existe um número limitado de massas de água que ajuda a prevenir inundações e secas.
...
Pelo contrário, os incêndios sem precedentes no pantanal atraíram menos atenção do que os
incêndios na Austrália, no oeste dos Estados Unidos e na Amazônia, seu irmão famoso ao
norte. Errada.

C The Amazon is considered part of the wetland, but located in the north. - A
Amazônia é
considerada parte do pantanal, mas é localizada ao norte.

É dito no texto que o Pantanal é irmão da Amazônia e que esta é situada no Norte.
No
entanto, a informação de que a Amazônia é considerada parte do pantanal não se encontra no
texto de forma clara. Errada.

D there are many reptiles amnog the animais found in Pantanal. - há muitos répteis entre os
animais encontrados no Pantanal.

O texto fala de vida selvagem e menciona onças, antas, ariranhas ameaçadas de extinção e
araras azuis brilhantes. Novamente, a informação de que há muitos répteis entre os
animais
encontrados no Pantanal não se encontra no texto. Errada.

E one phenomenon that takes place in the Pantanal was compared to the human respiratory
system. - um fenômeno que ocorre no Pantanal foi comparado ao sistema respiratório humano.

Ao falar do Pantanal é mencionado um ritmo que evoca um coração batendo: o pulso de
inundação. Novamente, a informação é confusa pois também se trata de sistema circulatório e
não apenas respiratório. Errada.
...
Os incêndios florestais foram agravados (worsened) pelas mudanças climáticas. Isso indica que
há outros fatores. Errada.

B the Pantanal is larger than Greece, Paraguay and Bolivia altogether. - o Pantanal é maior que
a Grécia, Paraguai e Bolívia juntos.

O que o texto diz é que o Pantanal é maior que a Grécia e se estende por partes do Brasil,
Paraguai e Bolívia. Errada.

C the Pantanal has had this kind of fires more often before. - o Pantanal já teve esse tipo de
incêndio com mais frequência.

O texto diz que os incêndios unprecedented (sem precedents) no pantanal atraíram menos
atenção do que os incêndios na Austrália, no oeste dos Estados Unidos e na Amazônia, seu
irmão famoso ao norte. A palavra unprecedented indica o Pantanal não teve esse tipo de
incêndio com mais frequência, como diz a assertiva. Errada.

D the water cycle in the Pantanal depends on the life of many animais, which live
there. - o
ciclo da água no Pantanal depende da vida de muitos animais que ali vivem.
...
This year, roughly a quarter of the vast Pantanal wetland in Brazil, one of the most biodiverse
places on Earth, has burned in wildfires worsened by climate change.

Este ano, cerca de um quarto da vasta área úmida do Pantanal no Brasil, um dos lugares com
maior biodiversidade da Terra, foi queimada em incêndios florestais agravados pelas mudanças
climáticas.
...
Como uma imensa banheira, o pântano se enche de água durante a estação chuvosa e esvazia
durante os meses secos. Apropriadamente, esse ritmo tem um nome que evoca um coração
batendo: o pulso de inundação.

swell - inchar, encher-se, dilatar-se, avolumar-se, expandir, crescer

A expressão "becomes flooded" pode substituir o verbo "swell" sem prejudicar a
interpretação do texto. Essa é a correta.
...
Na mudança da Voz Passiva para a Ativa o que é sujeito passa a ser objeto e vice-versa. Além
disso, deve se manter o mesmo tempo verbal. O tempo verbal do enunciado é Present Perfect
e da opção também. Essa é a opção correta.

B For centuries, fire is used by ranchers to clear fields and new land. - Durante séculos, o fogo
é usado pelos fazendeiros para limpar campos e novas terras.
...
D For centuries, fire was used by ranchers to clear fields and new land. - Durante séculos, o
fogo foi usado por fazendeiros para limpar campos e novas terras.

E For centuries, fire is being used by ranchers to clear fields and new land. - Durante séculos, o
fogo está sendo usado por fazendeiros para limpar campos e novas terras.
...
Este ano, cerca de um quarto da vasta área úmida do Pantanal no Brasil, um dos lugares com
maior biodiversidade da Terra, foi queimada em incêndios florestais agravados pelas mudanças
climáticas. O que acontece com um bioma rico e único quando tanto é destruído?
...
embora o Pantanal não seja um nome familiar a nível mundial, os turistas que conhecem o local
migram para lá porque é o lar de concentrações excepcionalmente altas de vida selvagem de
tirar o fôlego: onças, antas, ariranhas ameaçadas de extinção e araras azuis brilhantes. Como
uma imensa banheira, o pântano se enche de água durante a estação chuvosa e esvazia
durante os meses secos. Apropriadamente, esse ritmo tem um nome que evoca um coração
batendo: o pulso de inundação.
...
ajudam a prevenir enchentes e secas. Eles também armazenam quantidades incalculáveis de
carbono, ajudando a estabilizar o clima.
...
Durante séculos, os fazendeiros têm usado o fogo para limpar campos e novas terras. Mas este
ano, a seca agravada pela mudança climática transformou os pântanos em um barril de pólvora
...
Officers identified this hardship and began making a difference in many kids' lives
when the
department established its Cops Mentoring Kids program during the 2015-2016 academic
...
16 recruitment efforts by criminal organizations should concern everyone. Adolescents trying to
find their place in the world become most vulnerable to enticement by these

19 groups. Building young people's self-esteem and values provides resilience against criminal
predators' misguidance.
...
In Hollywood, a typical medium-sized town in the American state of Florida, the Police
Department (PD) values the development of its community's youth. The agency recognizes
the importance of raising young people to become upstanding, law-abiding citizens. The town
serves as home to over 20,000 youth, some of whom live in underprivileged areas and need
...
O órgão reconhece a importância de educar os jovens para se tornarem cidadãos íntegros e
cumpridores da lei. A cidade é o lar de mais de 20.000 jovens, alguns dos quais
vivem em
áreas desfavorecidas e precisam de modelos positivos.
...
jovens da cidade residem em áreas economicamente desfavorecidas e precisam de modelos
positivos de comportamento. Não se refere ao fato de muitos jovens residirem na área urbana
da cidade.
...
pelos
alunos das escolas locais e do Departamento de Polícia.

A expressão "Policiais Mentores de Crianças" é o nome do programa, mas esse programa não
foi criado pelos alunos das escolas da localidade. Segundo o texto, foi
criado pelo
departamento de polícia para o trabalho com os alunos em situação de risco dessas escolas.
...
17.Conclui-se do texto que trabalhar para elevar a autoestima e os valores dos jovens é uma
forma de impedir que essas pessoas se tornem criminosas.

O texto faz uma conexão do programa dos policiais agirem como mentores com o aumento da
autoestima e dos valores dos jovens e afirma que isso ajuda a prevenir o recrutamento
dos
jovens por organizações criminosas.
...
In Hollywood, a typical medium-sized town in the American state of Florida, the Police
Department (PD) values the development of its community's youth. The agency recognizes the
importance of raising young people to become upstanding, law-abiding citizens.

Em Hollywood, uma típica cidade de médio porte do estado americano da
Flórida, o
Departamento de Polícia (PD) valoriza o desenvolvimento da juventude de sua comunidade. O
órgão reconhece a importância de educar os jovens para se tornarem cidadãos íntegros e
cumpridores da lei.

The town serves as home to over 20,000 youth, some of whom live in underprivileged
areas
and need positive role models. Officers identified this hardship and began making a difference
in many kids' lives when the department established its Cops Mentoring Kids program during
the 2015-2016 academic year.

A cidade é o lar de mais de 20.000 jovens, alguns dos quais vivem em áreas desfavorecidas e
precisam de modelos positivos. Os policiais identificaram essa dificuldade e começaram a fazer
a diferença na vida de muitas crianças quando o departamento estabeleceu o programa
Policiais Mentores de Crianças durante o ano letivo de 2015-2016.

This initiative connects police officers who serve as mentors with at-risk students in
local
...
gerações futuras. O combate e a prevenção de esforços de recrutamento por parte de
organizações criminosas devem preocupar a todos.

Adolescents trying to find their place in the world become most vulnerable to
enticement by
these groups. Building young people's self-esteem and values provides resilience against
criminal predators' misguidance.

Internet: < https://leb.fbi.gov> (adapted).

Adolescentes que tentam encontrar seu lugar no mundo tornam-se os mais vulneráveis à
sedução por parte desses grupos. A construção da autoestima e dos valores dos jovens
oferece resiliência contra a orientação equivocada de predadores criminosos.
...
The same nerves involved in the fight-or-flight response can cause permanent damage
to the cells responsible for producing hair color in mice, scientists

4 have found. There is some truth to the longstanding anecdote that your locks can lose color
when you're stressed.

7 A team of researchers has found that in mice, stressful events damage the stem cells that are
responsible for producing pigment in hair. These stem cells, found near
...
13 makes the stem cells differentiate faster, exhausting their number and resulting in
strands
that are more likely to be transparent — gray.

16 The study also found that the sympathetic nervous system, which prepares the body
to
...
22 reversible," said Ya-Chieh Hsu. Stress affects the whole body, so the researchers had to do
some investigation to figure out which

25 physiological system was conveying its effects to hair follicles. The findings provide the first
scientific link between stress and hair graying. The new study is an
...
18 The common-sense belief according to which a person's hair can turn gray when he or she is
stressed is something new.

18 A crença do senso comum segundo a qual o cabelo de uma pessoa pode ficar grisalho
quando ela está estressada é algo novo.

Pelo contrário, o texto diz que existe uma crença antiga (longstanding anecdote) de
que o
cabelo de uma pessoa pode perder a cor quando ele/ela está sob stress. Portanto, não
se
pode dizer que essa crença é algo novo.

GABARITO: ERRADA

19 Before the study mentioned in the text, a connection between stress and hair graying had
never been found in science.

19 Antes do estudo mencionado no texto, nunca havia sido encontrada na ciência uma
conexão entre estresse e cabelos grisalhos.

O texto diz que as descobertas fornecem a primeira correlação científica entre o estresse e o
...
20 Os melanócitos são folículos capilares, que criam diferentes tons de cores no
cabelo e na
pele.

O texto diz que os melanócitos são células especializadas formadas na base de cada
folículo
capilar. Sendo assim, eles são células e não os próprios folículos.
...
Stress makes the stem cells differentiate faster, exhausting their number and
resulting in
strands that are more likely to be transparent — gray.

O estresse faz com que as células-tronco se diferenciem mais rapidamente,
exaurindo seu
número e resultando em filamentos com maior probabilidade de serem
transparentes -
cinza.
...
22 The effects of the sympathetic nervous system are permanent regarding the
fight-or-flight
response, but not regarding the graying process.

22 Os efeitos do sistema nervoso simpático são permanentes em relação à resposta
lutar ou
fugir, mas não em relação ao processo de envelhecimento.
...
fugir e
deve ser muito benéfico ou, pelo menos, seus efeitos devem ser transitórios
e reversíveis",
disse Ya-Chieh Hsu.
...
damage to the
cells responsible for producing hair color in mice, scientists have found. There is
some truth to
the longstanding anecdote that your locks can lose color when you're stressed.

Os mesmos nervos envolvidos na resposta de luta ou fuga podem causar danos permanentes
às células responsáveis pela produção da cor do cabelo em ratos, descobriram os
cientistas. Há
alguma verdade na antiga crença de que seus cabelos podem perder a cor quando você
está
estressado.

A team of researchers has found that in mice, stressful events damage the stem cells
that are
responsible for producing pigment in hair. These stem cells, found near the base of
each hair
follicle, differentiate to form more specialized cells called melanocytes, which
generate the
brown, black, red and yellow hues in hair and skin.

Uma equipe de pesquisadores descobriu que, em ratos, eventos estressantes
danificam as
células-tronco responsáveis pela produção de pigmentos no cabelo. Essas
células-tronco,
encontradas próximas à base de cada folículo piloso, se diferenciam para formar células
mais
especializadas chamadas melanócitos, que geram os tons de marrom, preto,
vermelho e
amarelo no cabelo e na pele.

Stress makes the stem cells differentiate faster, exhausting their number and
resulting in
strands that are more likely to be transparent — gray. The study also
found that the
...
número e resultando em filamentos com maior probabilidade de serem
transparentes - cinza.
O estudo também descobriu que o sistema nervoso simpático, que prepara o
corpo para
responder às ameaças, desempenha um papel importante no processo de envelhecimento.

"Normally, the sympathetic nervous system is an emergency system for fight or flight,
and it is
supposed to be very beneficiai or, at the very least, its effects are supposed to be
transient and
reversible," said Ya-Chieh Hsu. Stress affects the whole body, so the
researchers had to do
some investigation to figure out which physiological system was conveying its
effects to hair
follicles. The findings provide the first scientific link between stress and hair
graying. The new
study is an important step toward understanding the role of stress on various tissues.
...
deve ser muito benéfico ou, pelo menos, seus efeitos devem ser transitórios
e reversíveis",
disse Ya-Chieh Hsu. O estresse afeta todo o corpo, então os pesquisadores tiveram que
fazer
algumas investigações para descobrir qual sistema fisiológico estava transmitindo
seus efeitos
aos folículos capilares. As descobertas fornecem a primeira ligação científica
entre estresse e
cabelos grisalhos. O novo estudo é um passo importante para a compreensão
do papel do
...
América,
Brazil is still relatively closed compared to other large economies. Brazil is an
outlier in that its
trade penetration is extremely low, with trade at 24.1 percent of GDP in 2017. The
number of
exporters relative to the population is also very small: its absolute number
of exporters is
roughly the same as that of Norway, a country with approximately 5 million people
compared
to BraziTs 200 million. While further integrating into the global
...
23 Segundo o texto, na época da publicação, havia oito países com economias maiores
que a
do Brasil.

Despite being the eighth largest economy in the world and the largest in Latin
América, Brazil
is still relatively closed compared to other large economies.

Apesar de ser a oitava maior economia do mundo e a maior da América Latina, o
Brasil ainda é
relativamente fechado em comparação a outras grandes economias.

O texto não diz que havia oito países com economias maiores que a do Brasil, mas
sim que o
...
written, Brazil
participated in international commerce at the same levei as other
countries with robust
economies.

24 Os autores apresentam dados que demonstram que, na época da redação do texto, o
Brasil
participava do comércio internacional no mesmo nível que outros países com
economias
robustas.

Pelo contrário, o texto diz que o Brasil tem uma participação muito baixa
no comércio
internacional em comparação com outros países com economias fortes.
...
25 The text cites Norway as an example of a country with a similar number of
exporters and
total population as Brazil.

25 O texto cita a Noruega como exemplo de país com número de exportadores e
população
total semelhantes ao Brasil.

O número absoluto de exportadores do Brasil é aproximadamente o mesmo que o
da
Noruega. No entanto, a Noruega tem aproximadamente 5 milhões de
habitantes em
comparação com 200 milhões do Brasil. Portanto, os dois países não têm
população total
semelhantes.
...
this will only
put weak local businesses and their workers at risk.

26 Os autores afirmam que se o Brasil expandir suas atividades de comércio
internacional, isso
apenas colocará em risco as empresas locais fracas e seus trabalhadores.

GABARITO: ANULADA

27 "Brazil" is the antecedent of the pronoun "its" in "its absolute number
of exporters" (third
sentence).

27 "Brasil" é o antecedente do pronome "seu" em "seu número absoluto de
exportadores"
(terceira frase).
...
approximately 5
million people compared to Brazil's 200 million.

O Brasil é um caso atípico na medida em que sua penetração comercial é
extremamente
baixa, com comércio de 24,1% do PIB em 2017. O número de exportadores em
relação à
população também é muito pequeno: seu número absoluto de
exportadores é
aproximadamente o mesmo que o da Noruega, um país com aproximadamente 5
milhões de
habitantes em comparação com 200 milhões do Brasil.

Numa questão como essa você precisa analisar o contexto. O pronome its remete ao
sujeito da
frase anterior: Brasil. O pronome é usado para que não se precise repetir a palavra Brasil.
...
Despite being the eighth largest economy in the world and the largest in Latin
América, Brazil
is still relatively closed compared to other large economies. Brazil is an outlier in
that its trade
penetration is extremely low, with trade at 24.1 percent of GDP in 2017.

Apesar de ser a oitava maior economia do mundo e a maior da América Latina, o
Brasil ainda é
relativamente fechado em comparação a outras grandes economias. O Brasil é um caso
atípico
na medida em que sua penetração comercial é extremamente baixa, com comércio de 24,1%
do PIB em 2017.

The number of exporters relative to the population is also very small: its
absolute number of
exporters is roughly the same as that of Norway, a country with approximately 5
million people
compared to Brazil's 200 million. While further integrating into the global
economy could
threaten uncompetitive companies and their workers, competitive businesses would
most likely
benefit. Brazil's insertion would also allow the country to better
leverage its competitive
advantages, such as in natural resource-based industries.

Idem. Ibidem (adapted).

O número de exportadores em relação à população também é muito pequeno: seu
número
absoluto de exportadores é aproximadamente o mesmo que o da Noruega, um
país com
aproximadamente 5 milhões de habitantes em comparação com 200 milhões do Brasil. Embora
uma maior integração na economia global possa ameaçar empresas não competitivas
e seus
trabalhadores, as empresas competitivas provavelmente se beneficiariam. A inserção
do Brasil
também permitiria ao país alavancar melhor suas vantagens competitivas, como
nas indústrias
...
Plans for international trips in 2020 were brought to an abrupt halt by
the Covid-19
pandemic. Around the world, once-crowded sights lay dormant.

The statistics speak for themselves. On 13 October, the International Air
Transport
Association (IATA) said that international traffic "has all but disappeared", with
airlines carrying
only about 10% of normal leveis.

By IATA's estimate, Covid-caused disruptions put more than 41 million jobs at risk
across
the travei and tourism sector.

In the absence of travellers, tourism boards, hotels and destinations have
turned to
virtual reality (VR) — a technology still in its relative infancy — to
keep would-be visitors
interested and prepare for the long road to recovery.
...
Faced with a new reality of diminished tourism, many believe that Covid-19 might be
the
watershed moment for VR that changes perceptions from a clever and occasional
marketing
trick to a permanent fixture of tourism marketing.
...
D "long road to recovery" (fourth paragraph). - "longo caminho para a
recuperação" (quarto
parágrafo).
...
In the absence of travellers, tourism boards, hotels and destinations have
turned to virtual
reality (VR) — a technology still in its relative infancy — to keep would-be visitors
interested
and prepare for the long road to recovery. What began for many as a
temporary stop-gap
measure may now be a long-term tool. IATA predicts that travei will not
resume to pre-
pandemic leveis until 2024.
...
interessados e se
preparar para o longo caminho de recuperação. O que começou para muitos
como uma
medida paliativa temporária, agora pode ser uma ferramenta de longo prazo. A
IATA prevê
que as viagens não retornarão aos níveis pré-pandêmicos até 2024.

Visto que a previsão para a volta das viagens na sua totalidade é 2024,
o turismo está se
apoiando na realidade virtual. A expressão do enunciado refere-se a ela,
citada no parágrafo
anterior. Essa é a opção correta.
...
Em todo o mundo, pontos turísticos antes lotados ficam desertos. Portanto, não se pode
dizer
que o setor de turismo tem sido ligeiramente ou levemente afetado pela pandemia. Errada.

B may face a change in the way services are promoted. - pode enfrentar uma
mudança na
forma como os serviços são promovidos.
...
Diante de uma nova realidade de turismo reduzido, muitos acreditam que a
pandemia do
Covid-19 pode ser o momento decisivo para a realidade virtual (RV) que muda as
percepções
de um truque de marketing inteligente e occasional, para um acessório
permanente de
marketing de turismo.

O segmento do texto acima deixa bem claro que o setor de turismo pode
enfrentar uma
mudança na forma como os serviços são promovidos, sendo usad a realidade virtual. Correta.
...
E is not expected to recover from the disruptions. - Não se espera que
se recupere das
interrupções.
...
Os planos para viagens internacionais em 2020 foram interrompidos
abruptamente pela
pandemia do Covid-19. Em todo o mundo, pontos turísticos antes lotados ficam desertos.

The statistics speak for themselves. On 13 October, the International Air Transport
Association
(IATA) said that international traffic "has all but disappeared", with airlines
carrying only about
10% of normal leveis.

As estatísticas falam por si mesmas. Em 13 de outubro, a Associação
Internacional de
Transporte Aéreo (IATA) afirmou que o tráfego internacional "praticamente
desapareceu",
com as companhias aéreas transportando apenas cerca de 10% dos níveis normais.

By IATA's estimate, Covid-caused disruptions put more than 41 million jobs at risk
across the
travei and tourism sector.

Pela estimativa da IATA, as interrupções causadas pela Covid colocaram mais de 41
milhões de
empregos em risco no setor de viagens e turismo.
...
virtual (RV) - uma tecnologia ainda em sua infância - para manter os visitantes
interessados e se
preparar para o longo caminho de recuperação.

What began for many as a temporary stop-gap measure may now be a long-term
tool. IATA
predicts that travei will not resume to pre-pandemic leveis until 2024.

O que começou para muitos como uma medida paliativa temporária, agora pode
ser uma
ferramenta de longo prazo. A IATA prevê que as viagens não retornarão aos
níveis pré-
pandêmicos até 2024.
...
prevent prohibit, interdict
shedding change, lose
spend pass, expend
strain stress, pain
...
with a very thin
atmosphere. Mars is also a dynamic planet with seasons, polar ice caps,
canyons, extinct
volcanoes, and evidence that it was even more active in the past.
...
Mars' surface, many
speculated that an intelligent alien species resided there. This led to
numerous stories about
Martians, some of whom invade Earth, like in the 1938 radio drama, The War of the
Worlds.
According to an enduring urban legend, many listeners believed the story to
be real news
coverage of an invasion, causing widespread panic.

Countless stories since have taken place on Mars or explored the
possibilities of its Martian
inhabitants. Movies like Total Recall (1990 and 2012) take us to a
terraformed Mars and a
struggling colony running out of air. A Martian colony and Earth have a prickly
relationship in
The Expanse television series and novels.
...
by
extreme events. According to the Fourth National Climate Assessment, published
in 2018 by
the U.S. Global Change Research Program, "more frequent and intense extreme
weather and
climate-related events, as well as changes in average climate conditions, are
expected to
...
As the impacts of extreme events continue to mount, interest has grown in the
scientific
community to study whether specific extreme events can be partially attributed
to human
activities. With the help of climate models, scientists have conducted an
impressive array of
studies, looking for possible links between human activities and extreme events
such as heat
...
04 Certain extreme weather and climate-related events are happening more
often and
becoming more intense.

05 The author points out human contributions as a noteworthy reason for the growing
number
of extreme events.

06 Experts predict an abrupt change in climate conditions due to continually
harmful human
activities.

Texto 3: Analista Ambiental - IBAMA - CESPE - 2022

The European Environment Agency (EEA) has published a new indicator that
tracks
findings of pesticides in Europe's rivers, lakes and groundwaters. The data, collected
from EEA
...
were
measured in a quarter of all reported monitoring sites in European surface
waters in 2019.
From 2013 to 2019, this share varied between 13% and 30%. The share for groundwater
with
exceedances was considerably lower, at between 3% and 7%.

In the EU, pesticides are regulated on the basis of high protection goals
for human
health and the environment, with being authorised only after a comprehensive
scientific risk
assessment. Nevertheless, pesticide contamination of surface waters and groundwater
can still
occur and could affect aquatic fauna and flora.
...
07 From 2013 to 2019, the percentage of sites in European surface waters
whose leveis of
pesticides are above the limits more than doubled.

08 Contamination by pesticides in European waters is less likely to occur than in
other places in
the world due to strict control policies.
...
This year, roughly a quarter of the vast Pantanal wetland in Brazil, one of the most
biodiverse
places on Earth, has burned in wildfires worsened by climate change. What happens to
a rich
and unique biome when so much is destroyed?

The unprecedented fires in the wetland have attracted less attention than
blazes in Australia,
the Western United States and the Amazon, its celebrity sibling to the
north. But while the
Pantanal is not a global household name, tourists in the know flock there because it
is home to
exceptionally high concentrations of breathtaking wildlife: Jaguars, tapirs,
endangered giant
otters and bright blue hyacinth macaws. Like a vast tub, the wetland swells with
water during
the rainy season and empties out during the dry months. Fittingly, this rhythm has a
name that
evokes a beating heart: the flood pulse.

The wetland, which is larger than Greece and stretches over parts of
Brazil, Paraguay and
Bolívia, also offers unseen gifts to a vast swath of South América by regulating the
water cycle
upon which life depends. Its countless swamps, lagoons and tributaries purify
water and help
prevent floods and droughts. They also store untold amounts of carbon, helping to
stabilize the
climate.

For centuries, ranchers have used fire to clear fields and new land. But
this year, drought
worsened by climate change turned the wetlands into a tinderbox and the
fires raged out of
control.
...
E one phenomenon that takes place in the Pantanal was compared to the human
respiratory
system.
...
4 recognizes the importance of raising young people to become
upstanding, law-abiding
ócitizens. The town serves as home to over 20,000 youth, some of
whom live in
underprivileged areas and need positive role models.

8 Officers identified this hardship and began making a difference in many
kids' lives when

10 the department established its Cops Mentoring Kids program during
the 2015-2016
academic year. This initiative connects police officers who serve as mentors
with at-risk
students in local schools.

Mentoring provides an avenue to change future generations' mind-sets. Countering
and
preventing recruitment efforts by criminal organizations should concern everyone.
Adolescents
trying to find their place in the world become most vulnerable to enticement by these
groups.
Building young people's self-esteem and values provides resilience against
criminal predators'
misguidance.
...
14.The expression "this hardship" (I.8) refers to information presented in the
end of the first
paragraph: the fact that many young people live in the town's urban area.

15.The expression "Cops Mentoring Kids" (1.10) is the name of the program
created by the
students of local schools and the Police Department.
...
4 have found. There is some truth to the longstanding anecdote that your locks can
lose color
when you're stressed.

7 A team of researchers has found that in mice, stressful events damage the stem
cells that are
responsible for producing pigment in hair. These stem cells, found near

10 the base of each hair follicle, differentiate to form more specialized cells called
melanocytes,
which generate the brown, black, red and yellow hues in hair and skin. Stress

13 makes the stem cells differentiate faster, exhausting their number and
resulting in strands
that are more likely to be transparent — gray.

16 The study also found that the sympathetic nervous system, which prepares
the body to
respond to threats, plays a major role in the graying process. "Normally, the

19 sympathetic nervous system is an emergency system for fight or flight, and it is
supposed to
be very beneficiai or, at the very least, its effects are supposed to be transient and

22 reversible," said Ya-Chieh Hsu. Stress affects the whole body, so the researchers
had to do
some investigation to figure out which 25 physiological system was conveying its
effects to hair
follicles. The findings provide the first scientific link between stress and hair
graying. The new
study is an
...
18 The common-sense belief according to which a person's hair can turn gray when he
or she is
stressed is something new.

19 Before the study mentioned in the text, a connection between stress and hair
graying had
never been found in science.
...
to BraziTs 200 million. While further integrating into the global
economy could threaten
uncompetitive companies and their workers, competitive businesses would most
likely benefit.
BraziTs insertion would also allow the country to better leverage its
competitive advantages,
such as in natural resource-based industries.
...
27 "Brazil" is the antecedent of the pronoun "its" in "its absolute number of
exporters" (third
sentence).
...
* O que mais foi cobrado na aula de hoje foi Interpretação Textual. Esse
assunto é visto
em todos os textos.
...
* Nessa aula 70% dos textos tiveram assuntos relacionados ou com o cargo ou
com a
instituição para qual o candidato está prestando concurso. Portanto, ao
revisar procure
priorizar aqueles textos que têm o vocabulário pertinente ao seu concurso. Ex:
meio-ambiente,
economia, turismo, fiscal/financeiro, saúde, etc.

* Marque as questões que não acertou para posterior revisão.

* Se desejar usar o fórum de dúvidas para as aulas escritas, por gentileza
mencione o meu
nome: Profa. ou diga que a pergunta é do curso em pdf, citando a questão
e/ou o
tópico e a página. Respondo o mais rápido possível, no máximo no mesmo
dia. Quanto a
outros assuntos como vídeo, slides, simulados ficam a cargo de outro(a) professor(a).
Portanto,
mencione sempre a que aula você se refere para que assim fique mais claro
para os
