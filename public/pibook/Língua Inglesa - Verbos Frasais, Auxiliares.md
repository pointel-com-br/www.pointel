...
uma só. Orações independentes são aquelas que por si só já tem uma ideia completa,
não
...
sentido
sozinhas. Elas são dependentes da oração principal. A conjunção subordinada será sempre
a
...
citado primeiro. No caso, o aluno procura primeiro entender o significado das palavras
(mais
...
tudo no mesmo patamar. Não foi dado mais importância a "descobrir o significado
das
...
Nos trechos "... por apresentar-se para outras atribuições ..." (linhas 17-18) e "faça
todas as
...
(D) getting rid of - be forgotten = livrar-se de - ser esquecido e (E) moving away
from - be
eliminated = afastar-se de - ser eliminado

Os dois primeiros verbos frasais das opções acima ambos tem significados opostos ao
verbo
...
verbo principal e sem mudar o sentido dele. São usados na formação de tempos verbais
e
...
para todos os verbos com exceção do to be (ser, estar). Além disso usamos o DO ou
DOES
para frases negativas no presente simples, e para enfatizar algo. O Does é para a
terceira
...
para o passado visto que o Dl D já indica que se fala do passado.
...
r) you need to correct the exercises tonight? (Você precisará corrigir os
exercícios hoje à
noite?)
...
como
auxiliar para fazer vários tempos verbais, todos eles vemos em detalhes nos tópicos em
que
...
abaixo. Nesse caso ele não é auxiliar e por isso precisa da ajuda de auxiliares para
fazer
...
e) A reduction in government's tax collection has been studied and
...
a) A França tem perdido, na média, um contribuinte milionário ou bilionário por dia
por razões
fiscais desde 1997.
...
e) Uma redução na arrecadação fiscal do governo tem sido estudada e negociada atravás
da
Internet.
...
São verbos
auxiliares que servem para exprimir uma atitude de um falante em relação à
probabilidade ou
possibilidade de um acontecimento, bem como um palpite ou dedução (um palpite baseado
em
evidência), para pedir permissão e assim por diante. Existem 9 verbos modais
e três semi-
modais:
...
No exemplo acima, o modal must expressa uma crença de certeza. Mas, embora
para você
...
o falante acha
que é necessária. Nesse caso ele é equivalente ao Have to mas apenas em frases
afirmativas. A
...
Ao se referir a um tempo verbal no Passado, ao invés do must se usa o auxiliar
have, ficando
então had to.
...
Ao se referir a um tempo verbal no Futuro, ao invés do must se usa os auxiliares
will have (terá
que).
...
Estes três modais
(may,might,could) expressam a dedução (deduction) de que algo tem 50% de
chance de
...
Aquela igreja poderia ter capacidade para 1.000 pessoas. (Se fosse feita uma
reforma ou se
...
só tem
um vizinho: uma mulher que mora sozinha e é brasileira. Uma voz de homem, falando
alemão,
...
Quando
os modais são usados para falar sobre eventos passados, o modal é seguido
pelo infinitivo
perfeito, sem o to. O infinitivo perfeito é feito com have + o particípio
passado do verbo
...
usado como semi-
Modal, se torna estranho, pois seu uso é apenas na negativa e na
interrogativa. Observe a
...
preparar
a comida, embora não fosse necessário. Já no outro exemplo acima (verbo
usual), eu não
...
Nenhum outro
modal é seguido do to, apenas o ought to. Por essa razão ele é considerado
semi-modal, pois
tem essa característica de verbo não modal mas comporta-se como modal. O should é bem
mais
...
verbal
Futuro pois essa é uma função deles, formar o Futuro. O will é usado em todas as
pessoas e hoje
em dia é a forma predominante. O shall é usado mais no Inglês britânico
e apenas com as
pessoas / e We. Veja os exemplos abaixo:
...
negativas e
interrogativas, é seguido por um verbo no infinitivo sem o to e na terceira pessoa
do singular
sem o s.
...
Os auxiliares modais may e might são usados para expressar a possibilidade de que
algo possa
acontecer. Tanto são usados no Presente com no Futuro e não são sinônimos do have.
Portanto,
erradas.

Opção B: can = pode

Expressa habilidade, possibilidade, pede permissão ou faz um pedido. Não cabe
no lugar do
...
podem
ser usados como sinônimos no tempo presente, exceto que must sugere que é o narrador
é que
decidiu que algo é necessário, enquanto que o have sugere que alguém impôs a decisão.
No
contexto da questão, eles podem perfeitamente substituir um ao outro sem
prejuízo para o
...
Would
you like a cup of coffee? (Você aceita uma xícara de café?). Quando é usado junto
a outros
verbos ele equivale ao futuro do Pretérito em Português. Portanto se o
substituíssemos pelo
...
b) In South América, investors can develop the financial services market for products
such as
...
e) Governments of wealthy countries ought to of rich countries use strong money to
finance
...
d) Our plant invests in a new machinery, on the other hand our president forgets to
invest in
...
f) Countries in South América must invest in new technologies urgently, otherwise they won't be
...
l) She must be in trouble in the traffic because she never comes to
work late.
()
...
problemas no futuro porque nós não teremos mão de obra especializada na
empresa,
(probabilidade)
...
contrário eles não serão competitivos. Com certeza elas perderão terreno para países
mais
desenvolvidos, (necessidade)

g) Estamos proibidos de fazer isto porque é contra as leis em vigor/vigente. (proibição)

h) Dinheiro forte/valorizado deveria ser usado/utilizado para financiar investimentos em
países
pobres, (recomendação)
...
* As conjunções And (para listar itens ou ideias), But (para fazer um contraste
entre ideias
ou fatos) e Or (para discutir alternativas) são as principais e ligam duas
orações
...
* Muitas vezes o verbo modal Must é usado para expressar obrigação que o falante
acha
que é necessário. Nesse caso ele é equivalente ao Have to mas apenas em
frases
afirmativas.
...
* O verbo modal Can expressa habilidade, possibilidade, pede permissão ou
faz um
pedido
...
Some 12,000 people convened last week in Tunísia for a United Nations conference about
...
control over these domain names reflects no more than the histórica! accident of the
lnternet's
origins. Why should the United States continue to control the registration of French and Chinese
Internet addresses? It doesn't control the registration of French and Chinese cars,
whatever
...
unilateralism should be avoided. But in an imperfect world, unilateral solutions that run
efficiently
can be better than multilateral ones that 01.

The job of assigning domain names offers huge opportunities for abuse. 02 controls this
function can decide to keep certain types of individuais or organizations offline
(dissidents or
opposition política/ groups, for example). Or it can allow them on in exchange for large fees. The
striking feature of U.S. oversight ofthe Internet is that such abuses have not occurred.
...
candidate to take over the domain registry, has a record of resisting innovation
including the
...
entry. These clashes ofvision would probably make multilateral regulation inefficiently political.

You may say that th is is a fair price to pay to uphold the principie of sovereignty. Ifa country
wants to keep certain users from registering domain names (Nazi groups, child
pornographers,
criminais), then perhaps it has a right to do so. But the clinching argument is that countries can
exercise that sovereignty to a reasonable degree without controlling domain names. They
can
order Internet users in their territory to take offensive material down. They can order their banks
or credit card companies to refuse to process payments to unsavory Web sites based
abroad.
Indeed, governments' ample ability to regulate the Internet has already been
demonstrated by
some of the countries pushing for reform, such as authoritarian China. The sovereign nations of
the world have no need to wrest control of the Internet from the United States,
because they
already have it.
...
But in an imperfect world, unilateral solutions that run efficiently can be better
than multilateral
ones that don't. (51)
...
ficando então abreviado assim: don't ( do + not). O sujeito é: multilateral ones
(soluções
multilaterais) = they. Como o sujeito é a 3a pessoa do plural usa-se o DO, se
fosse a 3a do
singular seria o DOESN'T (does + not). Por isso, a letra E: DOESN'T está errada e a
letra A:
...
não tem sentido dizer que as soluções unilaterais por funcionarem de forma eficiente
são
...
eficientemente, o parágrafo está falando de fazer ou não fazer isso. Portanto o verbo
auxiliar
...
Whatever controls this function can decide to keep certain types of individuais or
organizations
offline (dissidents or opposition political groups, for example).

Seja o que for que controla esta função pode decidir manter certos tipos de
indivíduos ou
...
Whenever controls this function can decide to keep certain types of individuais or organizations
offline (dissidents or opposition political groups, for example).
...
Observe claramente como o texto fica confuso, e completamente comprometido na
sua
interpretação. Isto se dá pelo fato de que colocamos uma palavra que não se enquadra
no
espaço 02. Já no exemplo que indiquei acima, o texto flui com leveza e clareza, pois o whenever
é apropriado. Opção errada.

Opção C: Whichever = o que quer que, qual

Whichever controls this function can decide to keep certain types of individuais or organizations
offline (dissidents or opposition political groups, for example).
...
(talvez 2,3 ou 4). No texto a expressão é altamente abrangente, referindo-se a um
número
indefinido. Além disso, quando o which inicia uma frase sem referir-se a um substantivo, é usado
apenas para coisas, o que é incoerente com o texto pois quem pratica a ação de
controlar é
pessoa (s). Opção errada.

Opção D: Wherever = onde quer que

Wherever controls this function can decide to keep certain types of individuais or
organizations
offline (dissidents or opposition political groups, for example).

Onde quer que controla esta função pode decidir manter certos tipos de
indivíduos ou
organizações offline (dissidentes ou grupos políticos de oposição, por exemplo).
...
The job of assigning domain names offers huge opportunities for abuse. Whoever controls
this
function can decide to keep certain types of individuais or organizations offline
(dissidents or
...
quem for que controla esta função pode decidir manter certos tipos de
indivíduos ou
...
They have little time for moony merchandise. "Printed material containing roses, hearts
or any
form of promotion of Valentine's Day is forbidden," said another letter issued to
lran's printers.
"Whoever violates this order will be subjected to prosecution." (The Economist, February
14th,
2013)

Eles têm pouco tempo para mercadoria sonhadora. "Material impresso contendo rosas, corações
ou qualquer forma de promoção do Dia dos Namorados é proibida", disse outra carta
emitida
...
The delegates' argument is that unilateral U.S. control over these domain names
reflects no
more than/only the historical accident ofthe lnternet's origins.
...
The delegates' argument is that unilateral U.S. control over these domain names
reflects no
more than the historical accident ofthe lnternet's origins.
...
Ford's historie role in democratizing travei was?

Por que os Estados Unidos deveriam continuar a controlar o registro de endereços da Internet
franceses e chineses porque eles não controlam o registro de carros franceses e
chineses,
qualquer que tenha sido o papel histórico de Henry Ford em popularizar viagem.

Booster Example (Exemplo de Reforço):

But he will not consider applying for a full-time factory job because Mr. Wang, as a
college
...
motivo da primeira acontecer. No texto, o fato dos Estados Unidos não controlarem o
registro
...
Por que os Estados Unidos deveriam continuar a controlar o registro de endereços da Internet
franceses e chineses entretanto eles não controlam o registro de carros franceses e
chineses,
qualquer que tenha sido o papel histórico de Henry Ford em popularizar viagem.

O however deixa o texto truncado, pois ele não é o conectivo apropriado para ligar
as duas
sentenças. Errada.
...
Esta preposição despite é usada para introduzir um fato que torna a outra parte da
sentença
parecer surpreendente. Não é o caso do texto, o fato de que os EUA não controlarem
os
registros de carros franceses e chineses não é um fato que torna a parte antecedente
da
...
O sujeito da primeira frase é o mesmo da segunda, ou seja, são os Estados que
controlam o
registro de endereços e não controlam o registro de carros. Como eles podem fazer isso se não
fazem aquilo? O if não altera a compreensão do texto ao conectar as duas frases,
muito pelo
...
que o texto cita French (franceses) e Chinese (chineses). Mas não tem nada a ver o
que a
...
A palavra democratizing tem um outro sentido no texto, não tem nada a ver com partido
político. Errada.
...
algo que ocorreu no passado. Como não existe a opção arrependimento abaixo, então a
resposta correta é a letra C: recomendação.
...
The reformers1 argument is attractive in theory and dangerous in practice. In an
ideal world,
...
O autor admoesta que o unilateralismo deve ser evitado em um mundo ideal. Esta é a
opção
correta.
...
Os Estados Unidos não deixam de fora alguns tipos de indivíduos ou grupos em nem
cobram
taxas exorbitantes para permiti-los ter um nome domínio. Portanto, como não existem
esses
abusos, qualquer organização que queira registrar um nome domínio pode fazê-lo. Esta é
a
opção correta.
...
A alternativa traz uma informação oposta ao texto. A proibição de registro
de sites é
...
pornografia não é mencionada. E mesmo que a pornografia esteja inclusa em
grupos
...
Opção B: control of domain names = controle dos nomes domínios e Opção C: a number
of
...
The sovereign nations of the world have no need to wrest control of the Internet
from the
...
Ao fazer a troca do pronome pelo sujeito você verifica se o texto tem sentido, se
tiver está
...
(B) defende a possibilidade de cada país ter o direito de recusar o registro de
domínios a
...
Moreover, a multilateral domain-registering body would be caught between
the different
visions of its members: on the one side, autocratic regimes such as Saudi Arabia and
China that
want to restrict access to the Internet; on the other side, open societies that want
low barriers to
entry. These clashes of vision would probably make multilateral
regulation inefficiently
political.

Além disso, um orgão multilateral de registro de domínio seria travado entre
as diferentes
visões de seus membros: de um lado, regimes autocráticos, como a Arábia Saudita e
China, que
querem restringir o acesso à Internet; do outro lado, as sociedades abertas que querem
baixas
barreiras à entrada. Estes confrontos de visão, provavelmente, fariam regulação
multilateral
de forma ineficientemente política.

O texto não defende essa ideia. Ao invés disso cita que este supervisor
ou órgão multilateral
causaria conflitos políticos. Opção errada.

Opção B: defende a possibilidade de cada país ter o direito de recusar o registro de
domínios a
usuários que considere indesejáveis.

A recusa de registros é considerado um abuso. Portanto, o texto
não defende essa
possibilidade. Errada.

Opção C: argumenta contra a necessidade de qualquer controle sobre o registro de
nomes de
domínio na Internet.

Errada. O texto argumenta contra a escolha de um órgão supervisor multilateral da
Internet, pois
isto poderia tornar o registro de domínio uma questão política. O argumento
não é contra
qualquer controle.
...
They can order their banks or credit card companies to refuse to process payments to
unsavory
Web sites based abroad.

Eles podem ordenar seus bancos ou empresas de cartão de crédito a se recusar a
processar
pagamentos para sites ofensivos com sede no exterior.

O argumento não é contra, e sim a favor dessa proibição. Opção errada.

Opção E: argumenta a favor de os Estados Unidos continuarem a controlar a
atribuição de
nomes de domínio na Internet.

The striking feature of U.S. oversight of the Internet is that such abuses have not occurred.

A característica marcante da supervisão da Internet pelos Estados Unidos é que tais
abusos não
ocorreram.

The reformers' argument is attractive in theory and dangerous in practice. In
an ideal world,
...
mundo ideal,
unilateralismo deve ser evitado. Mas, em um mundo imperfeito, soluções
unilaterais que
funcionam de forma eficiente pode serem melhor do que os multilaterais que não o fazem.

Observe nos fragmentos do texto que destaquei acima, que é mencionado não
haver certos
abusos por parte dos Estados Unidos. Isto mostra que o argumento do texto é favor de
que os
Estados Unidos (solução unilateral) continuem a controlar a atribuição de nomes
domínios na
...
Some 12,000 people convened last week in Tunisia for a United Nations
conference about the
Internet. Many delegates want an end to the U.S. Commerce Department's
control over the
assignment of Web site addresses (for example, http://www.washington-%20post.com/)
and e-
mail accounts (for example, johndoe@aol.com). The delegates' argument is that
unilateral U.S.
control over these domain names reflects no more than the historical accident
of the lnternet's
origins.

Aproximadamente 12.000 pessoas se reuniram na semana passada na Tunísia para a
Conferência
das Nações Unidas sobre a Internet. Muitas autoridades querem pôr um fim no
controle do
Departamento de Comércio dos Estados Unidos sobre a atribuição de endereços
de sites (por
exemplo, http://www.washington-%20post.com /) e contas de email
(por exemplo,
johndoe@aol.com). O argumento dos delegados é que o controle unilateral dos EUA sobre
esses
...
Chinese Internet
addresses? It doesn't control the registration of French and Chinese cars, whatever
Henry Ford's
historie role in democratizing travei was.

Por que os Estados Unidos deveriam continuar a controlar o registro de endereços da
Internet
franceses e chineses? Eles não controlam o registro de carros franceses e chineses,
qualquer que
tenha sido o papel histórico de Henry Ford em popularizar viagem .
...
function can decide to keep certain types of individuais or organizations
offline (dissidents or
opposition political groups, for example). Or it can allow them on in exchange for
large fees. The
striking feature of U.S. oversight of the Internet is that such abuses have not occurred.

O trabalho de atribuição de nomes de domínio oferece enormes oportunidades para abuso.
Seja
quem for que controla esta função pode decidir manter certos tipos
de indivíduos ou
organizações offline (dissidentes ou grupos políticos de oposição, por
exemplo). Ou pode
permiti-los em troca de uma boa quantia em taxas. A característica marcante da
supervisão da
Internet pelos Estados Unidos é que tais abusos não ocorreram.

It's possible that a multilateral overseer of the Internet might be just as
efficient. But the
ponderous International Telecommunication Union, the U.N. body that would
be a leading
candidate to take over the domain registry, has a record of resisting
innovation including the
advent of the Internet.

É possível que um supervisor multilateral da Internet possa ao mesmo tempo
eficiente. Mas a
poderosa União Internacional de Telecomunicações, o órgão da ONU, que
seria um dos
principais candidatos para assumir o registro do domínio, tem um histórico de resistir
a inovação
incluindo o advento da Internet.

Moreover, a multilateral domain-registering body would be caught between the
different visions
of its members: on the one side, autocratic regimes such as Saudi Arabia and China
that want to
restrict access to the Internet; on the other side, open societies that want low
barriers to entry.
These clashes of vision would probably make multilateral regulation inefficiently political.

Além disso, um orgão multilateral de registro de domínio seria travado entre as
diferentes visões
de seus membros: de um lado, regimes autocráticos, como a Arábia Saudita e
China, que
querem restringir o acesso à Internet; do outro lado, as sociedades abertas que querem
baixas
barreiras à entrada. Estes confrontos de visão, provavelmente, fariam regulação
...
wants to keep certain users from registering domain names (Nazi groups, child
pornographers,
criminais), then perhaps it has a right to do so. But the clinching argument is that
countries can
exercise that sovereignty to a reasonable degree without controlling domain
names. They can
order Internet users in their territory to take offensive material down. They can
order their banks
or credit card companies to refuse to process payments to unsavory Web
sites based abroad.
Indeed, governments' ample ability to regulate the Internet has already been
demonstrated by
some of the countries pushing for reform, such as authoritarian China. The sovereign
nations of
the world have no need to wrest control of the Internet from the United
States, because they
already have it.

(Adapted from Washington Post, November 21,2005; A14)

Você pode dizer que este é um preço justo a pagar para manter o princípio de
soberania. Se um
país quer manter certos usuários de registro de nomes de domínio (grupos
nazistas, pedófilos,
criminosos), então talvez ele tenha o direito de fazê-lo. Mas o argumento
decisivo é que os
países podem exercer essa soberania em um grau razoável sem controlar os nomes de
domínio.
Eles podem ordenar os usuários da Internet no seu território a retirar
material ofensivo. Eles
podem ordenar seus bancos ou empresas de cartão de crédito a se recusar a
processar
pagamentos para sites ofensivos com sede no exterior. Na verdade, a ampla
capacidade dos
governos para regular a Internet já foi demonstrada por alguns dos países que
pressionam por
reforma, como a China autoritária. As nações soberanas do mundo não têm
necessidade de
...
and audience.
A special collections professional may experience much of this variety over the course
of his/her
career, taking on different public and technical service duties,
curatorial functions, and
management responsibilities. Even those who remain focused on a single
functional specialty
within one institution will best contribute to that institution's vitality
and success by developing
broad awareness of the full array of responsibilities that define the field as a
whole. We assume a
professional who gradually achieves such general proficiency over the course of
his/her career;
full mastery in all areas, however, is by no means expected.
...
Pelo contrário, um profissional de coleção especial pode assumir diferentes
funções de serviço
público. Não se restringe a um público específico. Errada.

(B) dependem, fundamentalmente, do profissional responsável por elas.

Elas não dependem do profissional, mas sim do ambiente institucional, natureza
das coleções,
...
instituição a
qual pertencem as Coleções Especiais em bibliotecas. Errada.

(D) são muito diferentes umas das outras e variam sob diversos aspectos.

Today's special collections environments are increasingly diverse. They vary
significantly with
regard to institutional setting, nature of collections, scope of
functions and services, and
audience. A special collections professional may experience much of this
variety over the
course of his/her career, taking on different public and technical
service duties, curatorial
functions, and management responsibilities.

Os ambientes de coleções especiais atuais são cada vez mais diversos.
Eles variam
significativamente com relação ao ambiente institucional, natureza das coleções,
no âmbito
de funções e serviços e o público. Um profissional de coleção especial pode
experimentar muito
desta variedade ao longo do curso de sua carreira, assumindo diferentes
funções de serviço
público e técnico, funções de curadoria e responsabilidades de gerenciamento.
...
Pelo contrário, o texto diz que se espera que o profissional gradualmente atinja tal
proficiência
geral ao longo do curso de sua carreira; mas não exigido o pleno domínio em todas
as áreas.
Errada.
...
em uma única
especialidade funcional dentro de uma instituição)... - aponta para um profissional cujo perfil
...
"Um profissional de coleção especial pode experimentar muito desta variedade ao
longo do
curso de sua carreira,..."

"Even those who remain focused on a single functional specialty within one institution
will best
contribute to that institution's ..."

"Até mesmo aqueles que permanecem focados em uma única especialidade funcional
dentro
de uma instituição..."

Even - até mesmo, inclusive

Uma questão como essa é essencial que você analise o contexto. O advérbio
even nesse
contexto é usado como um intensivo especialmente para indicar algo inesperado. Observe
que a
frase em questão comenta sobre os profissionais que estão focados em uma única
especialidade
funcional, em contraste com os profissionais de coleções especiais, que podem
experimentar a
diversidade ao longo da carreira. Sendo assim, a quarta frase do texto
aponta para um
profissional cujo perfil contrasta com o descrito na frase anterior. Essa é a opção correta.
...
completa de
responsabilidades que definem o campo como um todo). - a expressão em
destaque, no
...
ter, não precisa
desenvolver. Além disso, esses são aspectos restritos que não condizem com o
significado da
expressão em destaque. Erradas.

(C) interesses específicos.

O segmento já se refere a um profissional que está focado em um interesse
específico e a
expressão indica que ele deve se alargar. Errada.

(D) consciência crítica.

Não se trata de filosofia, e sim de entendimento a respeito de vários
aspectos da profissão.
Errada.

(E) visão geral.

Even those who remain focused on a single functional specialty within one
institution will best
contribute to that institution's vitality and success by developing broad
awareness of the full
array of responsibilities that define the field as a whole.

Mesmo aqueles que permanecem focados em uma única especialidade funcional dentro de uma
instituição, contribuirão mais para a vitalidade e sucesso dessa instituição
por desenvolver uma
visão geral da gama completa de responsabilidades que definem o campo como um todo.
...
Observe o contexto e o significado das palavras do meu destaque em negrito. Está
claro, que a
expressão "broad awareness" em destaque associa-se à ideia de desenvolver uma visão
geral da
...
regard to institutional setting, nature of collections, scope of
functions and services, and
audience. A special collections professional may experience much of this variety over
the course
of his/her career, taking on different public and technical service duties, curatorial
functions, and
...
significativamente com relação ao ambiente institucional, natureza das coleções,
no âmbito de
funções e serviços e o público. Um profissional de coleção especial pode
experimentar muito
desta variedade ao longo do curso de sua carreira, assumindo diferentes
funções de serviço
público e técnico, funções de curadoria e responsabilidades de gerenciamento.
...
contribute to that institution's vitality and success by developing broad
awareness of the full
array of responsibilities that define the field as a whole. We assume a professional
who gradually
achieves such general proficiency over the course of his/her career; full
mastery in all areas,
...
Até mesmo aqueles que permanecem focados em uma única especialidade funcional
dentro de
uma instituição, contribuirão mais para a vitalidade e sucesso dessa
instituição por desenvolver
uma ampla consciência da gama completa de responsabilidades que definem o campo como um
todo. Esperamos que um profissional gradualmente atinja tal proficiência geral
ao longo do
...
Within the last few years, electronic resources have become a prominent, if not the
most
dominant, means of discovery and research for users of all types of libraries.
Although much of
the electronic content for which libraries provide access is in the form of electronic
journals, there
is a growing proliferation of databases and indexes that lead users directly
to full-text content,
both serial and monographic. The variety of electronic resources and means of
accessing them
has led to discussions regarding cataloging and online resource management.
Workflow and
concomitant staffing issues have also become prevalent in the literature as libraries
adjust to the
realities of acquiring and processing these nonprint materiais. Electronic
resources have
challenged the principies and practices of cataloging over the last several
years. The complex
nature of cataloging and the changes necessitated by electronic resources have led to
the need
for guides to explain the rules in what may be perceived as more "practical" terms.
...
Within the last few years, electronic resources have become a prominent, if
not the most
dominant, means of discovery and research for users of all types of libraries.

Nos últimos anos, os recursos eletrônicos se tornaram um meio importante,
senão o mais
dominante, de descoberta e pesquisa para usuários de todos os tipos de bibliotecas.

O segmento textual acima deixa claro que os conteúdos em formato eletrônico
disponíveis em
bibliotecas ganham mais importância a cada dia. Essa é a opção correta.

(B) os periódicos em formato eletrônico acabaram, no uso diário, tomando o
lugar de seus
similares impressos.

Os recursos eletrônicos tem se tornado um meio muito importante de descoberta
e pesquisa
para usuários de todos os tipos de bibliotecas. Mas o autor não afirma que eles
tomaram o lugar
de seus similares impressos. Errada.

(C) as pesquisas realizadas em bancos de dados e índices eletrônicos substituem
gradualmente a
pesquisa em periódicos.

De acordo com o texto, embora grande parte do conteúdo eletrônico para o qual as
bibliotecas
fornecem acesso esteja na forma de revistas eletrônicas, há uma crescente
proliferação de
bancos de dados e índices que levam os usuários diretamente ao conteúdo
integral do texto,
...
Pelo contrário, mesmo com os bancos de dados e índices eletrônicos, há uma
crescente
proliferação da consulta ao texto completo de certas publicações. Errada.

(E) as obras monográficas continuam, em sua maioria, a ser consultadas em sua versão impressa.

Embora o texto diga que há uma crescente proliferação de bancos de dados e índices
que levam
os usuários diretamente ao conteúdo integral do texto, tanto serial quanto
monográfico, não se
afirma que a maioria das obras monográficas continuam a ser consultadas em
sua versão
impressa. Errada.
...
(D) os princípios e práticas da catalogação são constantes, quer os materiais sejam
impressos,
quer estejam em formato eletrônico.

(E) os desafios apresentados pelos conteúdos eletrônicos são semelhantes aos apresentados
por
materiais impressos já há muitos anos.
...
Nada a ver. O verbo challenge na frase expressa algo negativo. A explicação da opção
é algo
positivo, uma vantagem. Errada.

(B) os últimos anos viram um aumento de materiais eletrônicos a serem
catalogados nas
bibliotecas.

Quando o texto fala de últimos anos é para se referir ao tempo em que os recursos
eletrônicos
tem desafiado os princípios e práticas de catalogação. Errada.
...
Electronic resources have challenged the principies and practices of cataloging
over the last
several years. The complex nature of cataloging and the changes necessitated
by electronic
resources have led to the need for guides to explain the rules in what may be
perceived as more
"practical" terms.

Os recursos eletrônicos desafiaram os princípios e práticas de catalogação nos últimos
anos. A
natureza complexa da catalogação e as mudanças exigidas pelos recursos eletrônicos
levaram à
necessidade de guias para explicar as regras do que pode ser percebido em
termos mais
"práticos".

Observe o contexto posterior. O verbo "to challenge" expressa a ideia de
dificuldade a ser
superada. Isso quer dizer que a catalogação de conteúdos eletrônicos vem
trazendo certas
dificuldades ao trabalho do bibliotecário, ao ponto de precisarem de guias
para usar esses
recursos eletrônicos. Essa é a opção correta.
...
O texto não menciona em nenhum momento desafios apresentados por materiais
impressos,
mas sim recursos eletrônicos. Além disso, ele não se refere ao que aconteceu há
muitos anos,
mas sim nos últimos anos. Errada.
...
Nos últimos anos, os recursos eletrônicos se tornaram um meio importante,
senão o mais
dominante, de descoberta e pesquisa para usuários de todos os tipos de
bibliotecas. Embora
grande parte do conteúdo eletrônico para o qual as bibliotecas fornecem acesso esteja
na forma
de revistas eletrônicas, há uma crescente proliferação de bancos de dados e índices
que levam
os usuários diretamente ao conteúdo integral do texto, tanto serial quanto monográfico.

The variety of electronic resources and means of accessing them has led to discussions
regarding
cataloging and online resource management. Workflow and concomitant staffing
issues have
also become prevalent in the literature as libraries adjust to the realities
of acquiring and
...
e as questões
concomitantes de pessoal também se tornaram predominantes na literatura à
medida que as
bibliotecas se ajustam às realidades de adquirir e processar esses materiais não impressos.
...
treats
every entity as an object (instance of a class), and a relationship as an
inheritance. Some features
and benefits of an Object-Relational model are:
...
(A) a herança de um objeto corresponde a uma característica e a um benefício de um
modelo
OR.
...
The Object-Relational (OR) model is very similar to the relational model; however, it
treats every
entity as an object (instance of a class), and a relationship as an inheritance. Some
features and
benefits of an Object-Relational model are:

O modelo Objeto-Relacional (OR) é muito semelhante ao modelo relacional; no
entanto, ele
trata cada entidade como um objeto (instância de uma classe), e um relacionamento como
uma
herança. Algumas características e benefícios de um modelo de Objeto-Relacional são:
...
O texto diz que um relacionamento é tratado como se fosse uma herança. As palavras
não são
sinônimas. Observe acima as palavras que coloquei para você que são sinônimas
daquelas
citadas na opção. Errada.
...
O modelo Objeto-Relacional (OR) é muito semelhante ao modelo relacional; no
entanto, ele
trata cada entidade como um objeto (instância de uma
classe), e um
relacionamento como uma herança. Algumas características e benefícios de um
modelo de
Objeto-Relacional são:

Eles não são tratados da mesma forma. Está bem claro no texto que as entidades são
tratadas
como um objeto e os relacionamentos como herança. Portanto, não se pode
dizer que são
tratados da mesma forma. Opção Errada.
...
every entity as an object (instance of a class), and a relationship as an
inheritance. Some
features and benefits of an Object-Relational model are:

O modelo Objeto-Relacional (OR) é muito semelhante ao modelo relacional; no
entanto,
ele trata cada entidade como um objeto (instância de uma
classe), e um
relacionamento como uma herança. Algumas características e benefícios de um
modelo de
Objeto-Relacional são:

Cuidado ! O pronome pessoal it (neutro) na frase não está se referindo ao modelo
relacional.
...
The Object-Relational (OR) model is very similar to the relational model; however, it
treats every
entity as an object (instance of a class), and a relationship as an inheritance.

O modelo Objeto-Relacional (OR) é muito semelhante ao modelo relacional; no
entanto, ele
trata cada entidade como um objeto (instância de uma classe), e um
relacionamento como
uma herança.

O texto diz que os relacionamentos são tratados como herança. O que são
tratados como
instâncias de uma classe são os objetos. Opção errada.
...
required to belong to the set on values constituting the underlying domain.
...
Dica da Ena: Ao resolver uma questão como essa, lembre-se que em Inglês o adjetivo
vem
antes do substantivo (aula 02).

Temos aqui uma palavra que é cognato verdadeiro, a palavra domain parece com o Português e
realmente é (aula 00). Portanto, ao traduzir você troca a posição das palavras. Essa opção traz a
palavra domínio (domain) na mesma posição. Então, você já a elimina. Opção errada.
...
A domain constraint implies that a particular attribute of a relation is defined on a
particular
domain. A domain constraint simply states that values of the attribute in question are required to
belong to the set on values constituting the underlying domain.

(Database Fundamentais. Sharma, N. et al. DB2university.com, 1a. edição, 2010)

Uma restrição de domínio implica que um determinado atributo de uma relação é definida
em
um domínio particular. A restrição do domínio simplesmente afirma que os valores do
atributo
...
lowest levei the language mirrors the instruction set of the hardware. At mid-level programming
languages such as Ada 95, C or Smalltalk are used to create a procedural description
of the
...
(D) instruções executáveis são geradas automaticamente por linguagens de programação de
médio e alto nível.
...
At mid-level programming languages such as Ada 95, C or Smalltalk are used to create
a
procedural description of the program.

Em linguagens de programação de nível médio, como a Ada 95, a C ou Smalltalk são usados
para criar uma descrição sobre o procedimento do programa.

De acordo com o texto, os exemplos de linguagens citados na opção são de nível médio, não de
alto nível. Opção errada.
...
No nível mais alto, a linguagem utiliza ícones gráficos ou outra simbologia para representar os
...
At the highest levei the language uses graphical icons or other symbology to represent
the
requirements for a solution. Executable instructions are automatically generated.

No nível mais alto, a linguagem utiliza ícones gráficos ou outra simbologia para representar os
requisitos para uma solução. As instruções executáveis são geradas automaticamente.

As instruções executáveis são geradas automaticamente por linguagens de programação de
nível mais alto. Opção errada.
...
explicitly defined grammar and well-formed rules of syntax and semantics. At the lowest levei the
language mirrors the instruction set of the hardware.

Os componentes de software são construídos usando uma linguagem de programação que tem
um vocabulário limitado, uma gramática explicitamente definida e regras de sintaxe e semântica
bem formadas. No nível mais baixo, a linguagem reflete o conjunto de instruções do hardware.

At mid-level programming languages such as Ada 95, C or Smalltalk are used to create
a
procedural description of the program. At the highest levei the language uses graphical icons or
other symbology to represent the requirements for a solution. Executable instructions are
...
Em linguagens de programação de nível médio, como a Ada 95, a C ou Smalltalk são usados
para criar uma descrição sobre o procedimento do programa. No nível mais alto, a
linguagem
...
an intensely human endeavor will never have success in project management. A manager who
fails to encourage comprehensive customer communication early in the evolution of a
project
risks building an elegant solution for the wrong problem. Finally the manager who pays
little
attention to the process runs the risk of inserting competent technical methods and tools into a
vacuum.
...
(C) não deve dar pouca atenção ao processo, pois correrá orisco de perder bons
métodos e
ferramentas.
...
A gestão eficaz de projetos de software se concentra em três Pês: pessoas, problema, e
processo. A ordem não é arbitrária.

arbitrary = arbitrário, aleatório, decidido subjetivamente

A ordem não é aleatória, segundo diz o texto. Portanto, a opção se equivoca ao afirmar que os
três P's podem ser focados em uma ordem qualquer. Opção errada.

(B) deve se esforçar no sentido de encorajar os seus clientes a serem mais compreensivos.

A manager who fails to encourage comprehensive customer communication early in
the
evolution of a project risks building an elegant solution for the wrong problem.

Um gestor que não incentiva a comunicação abrangente do cliente no início da evolução de um
projeto corre o risco de construir uma solução elegante para o problema errado.

comprehensive = abrangente, integral, compreensivo
compreensivo = kind, sympathetic, understanding

O adjetivo aqui refere-se à comunicação do cliente como sendo algo abrangente. Não se trata
do cliente ser compreensivo. Observe acima os adjetivos em Inglês que coloquei pra você, que
mais são usados quando se quer mencionar que alguém é compreensivo, compassivo. Tenha
atenção ao que a palavra significa dentro do contexto. Opção errada.

BIZU DA ENA: Embora a palavra comprehensive também tenha o
significado de
compreensivo, geralmente ela é usada significando abrangente. Justamente por isso a VUNESP
elabora essa opção. A banca quer testar o conhecimento do candidato quanto à tradução
correta da palavra nesse contexto. Sempre que você ficar na dúvida em uma prova sobre essa
palavra, opte pela tradução como abrangente.

(C) não deve dar pouca atenção ao processo, pois correrá o risco de perder bons
métodos e
ferramentas.

Finally the manager who pays little attention to the process runs the risk of inserting competent
technical methods and tools into a vacuum.

Finalmente, o gerente que dá pouca atenção ao processo corre o risco de inserir
métodos e
instrumentos técnicos competentes em um vácuo.

In a vacuum = em um vácuo (sentido figurado) = sem nenhuma conexão com pessoas ou
eventos

O autor aqui faz uso da linguagem figurada, o que chamamos de expressão idiomática = idioms
(aula 06). Quando ele fala em inserir instrumentos e métodos competentes em um vácuo
significa que os perderá, pois não terão nenhum tipo de conexão e não servirão para nenhum
propósito. Esta é a opção correta.
...
É o contrário. Por ele ter falhado em incentivar a comunicação do cliente é que ele
dá uma
...
will
never have success in project management.

O gerente que se esquece de que o trabalho de engenharia de software é uma atividade
intensamente humana nunca terá sucesso em gerenciamento de projetos.

O texto refere-se especificamente à engenharia de software, não a todos os projetos de forma
abrangente como diz a opção. Além disso, a intensidade a que ele se refere é ser muito humana,
não é trabalhar intensamente. Opção errada.
...
Effective software project management focuses on the three P's: people, problem, and process.
The order is not arbitrary. The manager who forgets that software engineering work is
an
intensely human endeavor will never have success in project management.

A gestão eficaz de projetos de software se concentra em três Pês: pessoas, problema, e
processo. A ordem não é arbitrária. O gerente que se esquece de que o trabalho de engenharia
de software é uma atividade intensamente humana nunca terá sucesso em gerenciamento de
projetos.
...
evolution of a project risks building an elegant solution for the wrong problem.
Finally the
manager who pays little attention to the process runs the risk of inserting competent
technical
...
Um gestor que não incentiva a comunicação abrangente do cliente no início da evolução de um
projeto corre o risco de construir uma solução elegante para o problema errado. Finalmente, o
gerente que dá pouca atenção ao processo corre o risco de inserir métodos e
instrumentos
...
;Awareness = consciência; percepção; conhecimento; noção, visão.; As a whole = como
um todo.

* Dê atenção aos conectivos: However = entretanto, contudo, todavia; Therefore = por
consequência, por esse motivo, logo, portanto; Despite = Apesar de; Although = embora,
apesar de
...
* Os modais could, might, may e must são usados para expressar
possibilidade ou
probabilidade.
...
assignment of Web site addresses (for example, http://www.washington-%20post.com/ ) and e-
mail accounts (for example, johndoe@aol.com). The delegates' argument is that unilateral U.S.
control over these domain names reflects no more than the historical accident of the
lnternet's
origins. Why should the United States continue to control the registration of French and Chinese
Internet addresses? It doesn't control the registration of French and Chinese cars,
whatever
...
Today's special collections environments are increasingly diverse. They vary significantly
with regard to institutional setting, nature of collections, of functions and services, and
audience.
A special collections professional may experience much of this variety over the course of his/her
career, taking on different public and technical service duties, curatorial
functions, and
management responsibilities. Even those who remain focused on a single functional
specialty
within one institution will best contribute to that institution's vitality and
success by developing
broad awareness of the full array of responsibilities that define the field as a whole. We assume a
professional who gradually achieves such general proficiency over the course of his/her career;
full mastery in all areas, however, is by no means expected.
...
Within the last few years, electronic resources have become a prominent, if not the most
dominant, means of discovery and research for users of all types of libraries. Although much of
the electronic content for which libraries provide access is in the form of electronic journals,
there
is a growing proliferation of databases and indexes that lead users directly to
full-text content,
both serial and monographic. The variety of electronic resources and means of accessing them
has led to discussions regarding cataloging and online resource management. Workflow and
concomitant staffing issues have also become prevalent in the literature as libraries adjust to the
realities of acquiring and processing these nonprint materiais. Electronic
resources have
challenged the principies and practices of cataloging over the last several years. The
complex
nature of cataloging and the changes necessitated by electronic resources have led to the need
for guides to explain the rules in what may be perceived as more "practical" terms.
...
(B) os periódicos em formato eletrônico acabaram, no uso diário, tomando o lugar de
seus
similares impressos.

(C) as pesquisas realizadas em bancos de dados e índices eletrônicos substituem gradualmente a
pesquisa em periódicos.

(D) com os bancos de dados e índices eletrônicos, torna- -se desnecessária a consulta ao texto
completo de certas publicações.
...
(A) os princípios da catalogação se tornaram mais simples com o uso de
recursos
computadorizados.

(B) os últimos anos viram um aumento de materiais eletrônicos a serem catalogados nas
bibliotecas.

(C) a catalogação de conteúdos eletrônicos vem trazendo certas dificuldades ao trabalho
do
bibliotecário.
...
(E) os desafios apresentados pelos conteúdos eletrônicos são semelhantes aos apresentados por
materiais impressos já há muitos anos.
